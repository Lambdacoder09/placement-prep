...
#chapter(num: 4, title: "Averages, Mixtures & Alligation", tagline: "One number for a group. Then blend two groups.")[

#section[What you need to know]

#formulas(title: "Formula sheet")[
*Average.*
$ "Average" = "Sum of all values"/"Number of values" , quad "Sum" = "Average" times "Number" $
...
#ex(1, tier: 0)[Find the average of 14, 22, 31, 45 and 63.
#sol[Sum $= 14 + 22 = 36$; $36 + 31 = 67$; $67 + 45 = 112$; $112 + 63 = 175$. \
Average $= 175 div 5 = 35$.]
#ans[35]]

#ex(2, tier: 0)[Find the average of the first 20 natural numbers.
#sol[Average $= (n+1)/2 = 21/2 = 10.5$.]
#ans[10.5]]

#ex(3, tier: 0)[The average of 6 numbers is 42. Find their sum.
#sol[Sum $= "average" times "count" = 42 times 6 = 252$.]
#ans[252]]

#ex(4, tier: 0)[The average of 8 numbers is 25. The number 18 is replaced by 42. Find the new average.
#sol[Change in sum $= 42 - 18 = 24$. \
Change in average $= 24 div 8 = 3$. \
New average $= 25 + 3 = 28$.]
#ans[28]]

#ex(5, tier: 0)[The average of 5 numbers is 30. A sixth number, 48, is added. Find the new average.
#sol[Old sum $= 30 times 5 = 150$. \
New sum $= 150 + 48 = 198$. \
New average $= 198 div 6 = 33$.]
#ans[33]]

#ex(6, tier: 0)[4 kg of rice at Rs.~60/kg is mixed with 6 kg at Rs.~85/kg. Find the price per kg of the mixture.
#sol[Cost $= 4 times 60 = 240$ and $6 times 85 = 510$. \
Total cost $= 240 + 510 = 750$ for $4 + 6 = 10$ kg. \
Price $= 750 div 10 = 75$.]
#ans[Rs.~75 per kg]]

#ex(7, tier: 0)[In what ratio must goods costing Rs.~40 and Rs.~70 be mixed to cost Rs.~50 on average?
#sol[$C = 40$, $D = 70$, $M = 50$. \
$"cheaper"/"dearer" = (D - M)/(M - C) = (70 - 50)/(50 - 40) = 20/10 = 2/1$.]
#ans[$2 : 1$]]

#ex(8, tier: 0)[Find the mean and the median of 7, 3, 11, 9, 5, 15.
#sol[Mean: sum $= 7 + 3 + 11 + 9 + 5 + 15 = 50$; mean $= 50 div 6 = 8.33$ (2 d.p.). \
Median: sort them $arrow.r$ 3, 5, 7, 9, 11, 15. Count is even, so take the two middle values 7 and 9. \
Median $= (7 + 9)/2 = 8$.]
#ans[Mean $approx 8.33$, median $= 8$]]

#section[Tier 1 — Service companies]
#tier-header(1)

#ex(9, tier: 1, asked: "TCS NQT pattern")[The average of 11 numbers is 36. The average of the first six is 34 and the average of the last six is 39. Find the sixth number.
#sol[Total sum of all 11 $= 36 times 11 = 396$. \
Sum of first six $= 34 times 6 = 204$. \
Sum of last six $= 39 times 6 = 234$. \
...
#trick[*Overlap rule.* First $k$ $+$ last $k$ $-$ total $=$ the number counted twice, whenever the two groups together cover one more slot than the list has.]

#ex(10, tier: 1, asked: "Infosys pattern")[The average age of 30 students is 14 years. When the teacher's age is included, the average rises by 1 year. Find the teacher's age.
#sol[Old sum $= 14 times 30 = 420$. \
New count $= 31$. New average $= 14 + 1 = 15$. \
New sum $= 15 times 31 = 465$. \
Teacher's age $= 465 - 420 = 45$ years. \
Faster: the newcomer must carry the old average *plus* enough to lift all 31 heads by 1, so age $= 14 + 31 times 1 = 45$.]
#ans[45 years]]

#ex(11, tier: 1, asked: "Wipro pattern")[The average weight of 4 boxes is 62 kg. A fifth box is added and the average falls to 59 kg. Find the weight of the fifth box.
#sol[Sum of 4 boxes $= 62 times 4 = 248$. \
Sum of 5 boxes $= 59 times 5 = 295$. \
Fifth box $= 295 - 248 = 47$ kg.]
#ans[47 kg]]

#ex(12, tier: 1, asked: "Accenture pattern")[The average marks of a class of 40 students is 62. Later it is found that one student's mark of 78 was entered as 38. Find the correct average.
#sol[The sum was too small by $78 - 38 = 40$. \
Change in average $= 40 div 40 = 1$. \
Correct average $= 62 + 1 = 63$.]
#ans[63]]

#trap[*Decide the direction before you add.* The entered mark was *lower* than the true mark, so the recorded average is *too low* and must go up. Students who subtract get 61 and it looks just as reasonable.]

#ex(13, tier: 1, asked: "TCS NQT pattern")[A man drives 120 km at 40 km/h and returns over the same road at 60 km/h. Find his average speed for the whole journey.
#sol[Time out $= 120/40 = 3$ hours. \
Time back $= 120/60 = 2$ hours. \
Total distance $= 120 + 120 = 240$ km. Total time $= 3 + 2 = 5$ hours. \
Average speed $= 240/5 = 48$ km/h. \
Formula check: $(2 u v)/(u + v) = (2 times 40 times 60)/(40 + 60) = 4800/100 = 48$.]
#ans[48 km/h]]

#trap[*Average speed is not $(40 + 60)/2 = 50$.* The slower leg eats more time, so it gets more weight. The true answer is always below the plain average of the two speeds.]

#ex(14, tier: 1, asked: "Capgemini pattern")[The average of five consecutive even numbers is 36. Find the largest.
#sol[Consecutive even numbers are evenly spaced, so the average is the middle one. \
Middle number $= 36$. \
...
#ex(15, tier: 1, asked: "Cognizant pattern")[In what ratio must rice at Rs.~48/kg be mixed with rice at Rs.~72/kg so that the mixture is worth Rs.~56/kg?
#sol[$C = 48$, $D = 72$, $M = 56$. \
$"cheap"/"dear" = (D - M)/(M - C) = (72 - 56)/(56 - 48) = 16/8 = 2/1$. \
Check with 2 kg and 1 kg: cost $= 2 times 48 + 1 times 72 = 96 + 72 = 168$ for 3 kg, so $168 div 3 = 56$. Correct.]
#ans[$2 : 1$]]

#ex(16, tier: 1, asked: "TCS NQT pattern")[A shopkeeper mixes 30 kg of tea costing Rs.~260/kg with 20 kg costing Rs.~360/kg and sells the mixture at Rs.~330/kg. Find his profit percent.
#sol[Cost of first lot $= 30 times 260 = 7800$. \
Cost of second lot $= 20 times 360 = 7200$. \
Total cost $= 7800 + 7200 = 15000$ for $30 + 20 = 50$ kg. \
Cost price per kg $= 15000 div 50 = 300$. \
Profit per kg $= 330 - 300 = 30$. \
Profit percent $= 30/300 times 100 = 10%$.]
#ans[10%]]

#ex(17, tier: 1, asked: "Infosys pattern")[A vessel holds 60 litres of pure milk. 12 litres is drawn out and replaced with water. This is done once more. How much milk is left?
#sol[Fraction removed each time $= 12/60 = 1/5$. \
Fraction of milk remaining each time $= 1 - 1/5 = 4/5$. \
After two rounds, milk $= 60 times (4/5)^2$. \
$(4/5)^2 = 16/25$. \
Milk $= 60 times 16/25 = 960/25 = 38.4$ litres. \
...
#ans[38.4 litres of milk]]

#trick[*Use the formula $x(1 - y/x)^n$ only when the amount drawn each time is the same and the vessel is topped back to full.* If the vessel is not refilled, the concentration does not change at all — only the volume does.]

#ex(18, tier: 1, asked: "Accenture pattern")[A 40-litre mixture has milk and water in the ratio $3 : 1$. How much water must be added to make the ratio $3 : 2$?
#sol[Parts $= 3 + 1 = 4$. One part $= 40 div 4 = 10$ L. \
Milk $= 3 times 10 = 30$ L. Water $= 1 times 10 = 10$ L. \
Adding water leaves the milk unchanged at 30 L. \
In the new ratio $3 : 2$, milk is 3 parts $= 30$ L, so one part $= 10$ L. \
New water $= 2 times 10 = 20$ L. \
Water to add $= 20 - 10 = 10$ L.]
#ans[10 litres]]

#ex(19, tier: 1, asked: "Wipro pattern")[In a test, 20 boys average 68 marks and 30 girls average 78 marks. Find the class average.
#sol[Total marks of boys $= 20 times 68 = 1360$. \
Total marks of girls $= 30 times 78 = 2340$. \
...
#ex(20, tier: 1, asked: "TCS NQT pattern")[Six support agents closed these numbers of tickets in a day: 7, 9, 11, 11, 13, 69. Find the mean, the median and the mode. Which one describes a typical agent best?
#sol[Mean: sum $= 7 + 9 = 16$; $16 + 11 = 27$; $27 + 11 = 38$; $38 + 13 = 51$; $51 + 69 = 120$. \
Mean $= 120 div 6 = 20$. \
...
#ans[Mean 20, median 11, mode 11 — the median describes a typical agent]]

#trap[*A mean can sit outside the bulk of the data.* Whenever a question mentions one huge or tiny value, expect the mean and the median to disagree, and read carefully which one is asked for.]

#practice(tier: 1, time: "60 s/Q")[
+ Find the average of 8, 12, 17, 23 and 30.
+ The average of 9 numbers is 52. The average of the first five is 48 and of the last five is 56. Find the fifth number. #opts([52], [48], [56], [57.8])
...
+ A car covers 180 km at 45 km/h and another 180 km at 90 km/h. Find the average speed. #opts([60 km/h], [67.5 km/h], [75 km/h], [30 km/h])
...
+ 12 kg of sugar at Rs.~42/kg is mixed with 8 kg at Rs.~52/kg. Find the price per kg of the mixture. #opts([Rs.~46], [Rs.~47], [Rs.~48], [Rs.~42])
...
*3.* 38 years. Coach $= 25 + 13 times 1 = 38$; or new sum $= 26 times 13 = 338$ minus old sum $300$. \
*4.* 31.75. The sum was short by $49 - 19 = 30$, so the average rises by $30 div 40 = 0.75$. \
*5.* (a) 60 km/h. $(2 times 45 times 90)/(45 + 90) = 8100/135 = 60$. (b) 67.5 is the plain average of the speeds — wrong, because the slow leg takes longer. (c) 75 comes from weighting each speed by itself instead of by time: $(45 times 45 + 90 times 90)/(45 + 90) = 10125/135 = 75$. (d) 30 comes from using only one 180 km leg as the total distance: $180 div 6 = 30$. \
*6.* 15. The average of the first $n$ odd numbers is $n$ itself. \
*7.* $5 : 1$ (milk : water). Water costs 0, so $"water"/"milk" = (54 - 45)/(45 - 0) = 9/45 = 1/5$. \
*8.* 51.2 litres. $80 times (1 - 16/80)^2 = 80 times (0.8)^2 = 80 times 0.64$. \
*9.* 5 litres. Milk $= 35$ L and water $= 10$ L; for $7 : 3$ the water must be 15 L. \
*10.* Rs.~52,000. Manager $= 28000 + 16 times 1500 = 28000 + 24000$. \
*11.* 77. Multiplying every value by 3 multiplies the average by 3; subtracting 4 from every value subtracts 4 from the average. $27 times 3 - 4 = 77$. \
*12.* 17.25. New sum $= 90 + 21 + 27 = 138$, new count $= 8$, and $138 div 8 = 17.25$. \
*13.* (a) Rs.~46. Total cost $= 504 + 416 = 920$ for 20 kg. (b) 47 is the plain average of 42 and 52 — wrong, the weights differ. (c) 48 comes from swapping the weights: $(8 times 42 + 12 times 52)/20 = 960/20 = 48$. (d) 42 is the price of the *larger* lot; the blend price must sit strictly between 42 and 52. \
*14.* Mean 24, median 15. Sum $= 168$ and $168 div 7 = 24$; the middle of seven sorted values is the 4th, which is 15. \
*15.* 70.3. Total $= 30 times 64 + 35 times 70 + 35 times 76 = 1920 + 2450 + 2660 = 7030$ over 100 students.
]

#section[Tier 2 — Singapore & Thailand]
#tier-header(2)

#ex(21, tier: 2, asked: "Grab · pattern")[A driver earned an average of S\$148 per day on the first 5 days of the week and S\$225 per day on the last 2 days. Find his average for the whole 7-day week.
#sol[Earnings for the first 5 days $= 5 times 148 = 740$. \
Earnings for the last 2 days $= 2 times 225 = 450$. \
Total $= 740 + 450 = 1190$. \
Average $= 1190 div 7 = 170$.]
#ans[S\$170 per day]]

#ex(22, tier: 2, asked: "Shopee · pattern")[In March a seller had 8,000 orders at an average order value of S\$36. In April the order count rose 25% and the average order value fell 8%. Find the average order value across the two months together.
#sol[*March.* \
Orders $= 8000$. AOV $= 36$. \
Revenue $= 8000 times 36 = 288000$. \
*April.* \
Orders $= 8000 times 1.25 = 10000$. \
AOV $= 36 times 0.92 = 33.12$. \
Revenue $= 10000 times 33.12 = 331200$. \
*Combined.* \
...
#trap[*Do not average 36 and 33.12 to get 34.56.* April carried more orders, so it pulls the combined figure down past the midpoint. Always rebuild the two totals first.]

#ex(23, tier: 2, asked: "Agoda · pattern")[Over 30 nights a Bangkok hotel's average room rate was THB~2,800. Over the first 18 of those nights it was THB~2,500. Find the average over the remaining 12 nights.
#sol[Total over 30 nights $= 2800 times 30 = 84000$. \
Total over the first 18 nights $= 2500 times 18 = 45000$. \
Total over the last 12 nights $= 84000 - 45000 = 39000$. \
Average $= 39000 div 12 = 3250$.]
#ans[THB~3,250 per night]]

#ex(24, tier: 2, asked: "DBS · pattern")[A bank blends two bond funds, one yielding 3.2% and one yielding 5.6%, into a S\$4.8 million portfolio with an overall yield of 4.1%. How much sits in each fund?
#sol[Alligation on the yields. $C = 3.2$, $D = 5.6$, $M = 4.1$. \
$D - M = 5.6 - 4.1 = 1.5$. \
$M - C = 4.1 - 3.2 = 0.9$. \
$"amount at 3.2%"/"amount at 5.6%" = 1.5/0.9 = 15/9 = 5/3$. \
Total parts $= 5 + 3 = 8$. One part $= 4.8 div 8 = 0.6$ million. \
At 3.2%: $5 times 0.6 = 3.0$ million. \
At 5.6%: $3 times 0.6 = 1.8$ million. \
Check: interest $= 3.0 times 0.032 + 1.8 times 0.056 = 0.096 + 0.1008 = 0.1968$ million. \
$0.1968 div 4.8 = 0.041 = 4.1%$. Correct.]
#ans[S\$3.0 million at 3.2% and S\$1.8 million at 5.6%]]

#trick[*Alligation with decimals: clear them first.* Turn $1.5 : 0.9$ into $15 : 9$ and then $5 : 3$. You only ever need the ratio, so any common multiplier is free.]

#ex(25, tier: 2, asked: "Sea / Shopee · pattern")[A 90-litre tank is full of pure syrup. 18 litres is drawn off and replaced with water. This is repeated twice more, three rounds in all. Find the final ratio of syrup to water.
#sol[Fraction drawn each round $= 18/90 = 1/5 = 0.2$. \
Fraction of syrup kept each round $= 1 - 0.2 = 0.8$. \
After 3 rounds the syrup fraction $= (0.8)^3$. \
$(0.8)^2 = 0.64$. \
$(0.8)^3 = 0.64 times 0.8 = 0.512$. \
Syrup $= 90 times 0.512 = 46.08$ litres. \
...
#ans[Syrup : water $= 64 : 61$ (46.08 L and 43.92 L)]]

#trap[*$(0.8)^3$ is the syrup fraction of the whole tank, not the syrup-to-water ratio.* Convert to actual litres, or use $0.512 : (1 - 0.512)$. Writing the answer as $512 : 1000$ is a very common slip.]

#ex(26, tier: 2, asked: "SCB · pattern")[The average age of 8 analysts in a team is 31 years. Two analysts aged 26 and 34 leave, and two new analysts join whose average age is 24. Find the new team average.
#sol[Sum of ages now $= 31 times 8 = 248$. \
The two leavers total $26 + 34 = 60$. \
Sum after they leave $= 248 - 60 = 188$ for 6 people. \
The two joiners total $24 times 2 = 48$. \
New sum $= 188 + 48 = 236$ for $6 + 2 = 8$ people. \
New average $= 236 div 8 = 29.5$ years.]
#ans[29.5 years]]

#ex(27, tier: 2, asked: "LINE MAN · pattern")[A rider covers 12 km at 24 km/h, then 9 km at 18 km/h, then waits 10 minutes at a restaurant, then covers 15 km at 30 km/h. Find his average speed for the whole trip, counting the wait.
#sol[Leg 1 time $= 12/24 = 0.5$ h. \
...
Average speed $= 36 div 5/3 = 36 times 3/5 = 108/5 = 21.6$ km/h.]
#ans[21.6 km/h]]

#trap[*Waiting time counts.* It adds to the denominator and adds nothing to the numerator. Drop the 10-minute wait and you get 24 km/h, which is wrong by more than 10%.]

#ex(28, tier: 2, asked: "GIC · pattern")[A S\$8 million portfolio returned 7% for the year. It holds only equities returning 12% and bonds returning 4%. How much is in equities?
#sol[Alligation on returns. $C = 4$ (bonds), $D = 12$ (equities), $M = 7$. \
$D - M = 12 - 7 = 5$. \
$M - C = 7 - 4 = 3$. \
$"bonds"/"equities" = 5/3$. \
Total parts $= 5 + 3 = 8$. One part $= 8 div 8 = 1$ million. \
Bonds $= 5$ million. Equities $= 3$ million. \
Check: $3 times 0.12 + 5 times 0.04 = 0.36 + 0.20 = 0.56$ million on 8 million, and $0.56 div 8 = 0.07 = 7%$. Correct.]
#ans[S\$3 million in equities]]

#ex(29, tier: 2, asked: "Razer · pattern")[A shop buys 25 kg of premium coffee at THB~900/kg and 35 kg of regular coffee at THB~540/kg, blends them, and wants a profit of 25% on the blend. Find the selling price per kg.
#sol[Cost of premium $= 25 times 900 = 22500$. \
Cost of regular $= 35 times 540 = 18900$. \
Total cost $= 22500 + 18900 = 41400$. \
Total weight $= 25 + 35 = 60$ kg. \
Cost price per kg $= 41400 div 60 = 690$. \
Selling price $= 690 times 1.25$. \
$690 times 1.25 = 690 + 690 times 0.25 = 690 + 172.50 = 862.50$.]
#ans[THB~862.50 per kg]]

#ex(30, tier: 2, asked: "Grab · pattern")[Nine food deliveries took these times, in minutes: 18, 21, 22, 24, 25, 27, 29, 33, 125. The operations team must publish one number as the "typical delivery time". Find the mean and the median and say which should be published.
#sol[Mean: add in order. \
...
Publish the median.]
#ans[Mean 36 min, median 25 min — publish the median]]
...
*2.* S\$24,200. Feb+Mar+Apr $= 4 times 26000 - 30200 = 73800$; Jan $= 4 times 24500 - 73800$. Shortcut: Jan $=$ May $- 4 times ("difference of averages") = 30200 - 6000$. \
...
#ex(31, tier: 3, asked: "Google · pattern")[Twenty *distinct* positive integers have an average of 30. What is the largest value the biggest of them can take?
#sol[*Insight: the sum is locked. To push one value as high as possible, squeeze every other value as low as it is allowed to go.*

Sum of all twenty $= 30 times 20 = 600$. \
The other nineteen must be distinct positive integers, all different from each other. The smallest such set is $1, 2, 3, ..., 19$. \
Their sum $= (19 times 20)/2 = 190$. \
...
#ex(32, tier: 3, asked: "Amazon · pattern")[In a class of 50 the average score is 64. Every score is a whole number from 0 to 100. At most how many students could have scored above 90?
#sol[*Insight: turn "at most how many" into a budget question. The total score is fixed, and every high scorer spends a large slice of it.*

Total score $= 64 times 50 = 3200$. \
...
$3200 div 91 = 35.16 ...$ \
Therefore $k <= 35$. \
Now show 35 is actually reachable. Give 35 students exactly 91 marks: $35 times 91 = 3185$. \
Marks left $= 3200 - 3185 = 15$ for the remaining $50 - 35 = 15$ students. \
Give each of them 1 mark: $15 times 1 = 15$. \
Every score is a whole number between 0 and 100 and the total is $3185 + 15 = 3200$. Correct.]
#ans[35 students]]

#ex(33, tier: 3, asked: "Microsoft · pattern")[A tank holds 100 litres of pure acid. Every day 20 litres is drawn off and the tank is topped back to 100 litres with water. After how many days does the acid first fall below 50 litres?
#sol[*Insight: each day multiplies the acid by the same factor. So this is repeated multiplication, not repeated subtraction.*

Fraction drawn each day $= 20/100 = 0.2$. \
Fraction of acid kept each day $= 1 - 0.2 = 0.8$. \
After $n$ days, acid $= 100 times (0.8)^n$. \
We need $100 times (0.8)^n < 50$, that is $(0.8)^n < 0.5$. \
...
#ans[On day 4, with 40.96 litres left]]

#ex(34, tier: 3, asked: "Goldman Sachs · pattern")[A fund gains 50% in year 1 and loses 40% in year 2. A report states that "the average annual return was $+5%$, so the fund is up". Find the true two-year change, and explain the error in one line.
#sol[*Insight: percentages apply to different bases, so they multiply, they do not average. Turn each percent into a growth factor and multiply.*

Start with 100 units. \
Year 1 factor $= 1 + 0.50 = 1.5$. \
Value after year 1 $= 100 times 1.5 = 150$. \
Year 2 factor $= 1 - 0.40 = 0.6$. \
Value after year 2 $= 150 times 0.6 = 90$. \
True change $= 90 - 100 = -10$ on a base of 100, that is $-10%$ over two years. \
The error: the $+50%$ was earned on 100 but the $-40%$ was charged on 150, so the loss is bigger in money terms even though it is smaller in percent terms. $ 1.5 times 0.6 = 0.9 , quad "not" quad (1.5 + 0.6)/2 = 1.05 $]
#ans[The fund is down 10% over the two years]]

#ex(35, tier: 3, asked: "D. E. Shaw · pattern")[Tokens numbered 1 to 50 sit in a bag. Every token whose number is a multiple of 5 is removed. Find the average of the tokens that remain.
#sol[*Insight: do not list 40 numbers. Work with sums — the sum of what remains is the sum of everything minus the sum of what left.*

Sum of 1 to 50 $= (50 times 51)/2 = 1275$. \
Multiples of 5 up to 50: $5, 10, 15, ..., 50$. There are $50 div 5 = 10$ of them. \
Their sum $= 5(1 + 2 + ... + 10) = 5 times (10 times 11)/2 = 5 times 55 = 275$. \
...
#ex(36, tier: 3, asked: "Adobe · pattern")[Rice at Rs.~40, Rs.~50 and Rs.~70 per kg is mixed to sell at Rs.~55 per kg. The Rs.~40 and Rs.~50 varieties are used in the ratio $2 : 3$. Find the ratio of all three.
#sol[*Insight: alligation handles only two things at a time. So first fuse the two varieties whose ratio is already fixed into one imaginary variety, then alligate that against the third.*

Step 1 — price of the fused variety. \
Take 2 kg at 40 and 3 kg at 50. \
Cost $= 2 times 40 + 3 times 50 = 80 + 150 = 230$ for 5 kg. \
...
Ratio $= 2 : 3 : 3$. \
Check: $(2 times 40 + 3 times 50 + 3 times 70)/(2 + 3 + 3) = (80 + 150 + 210)/8 = 440/8 = 55$. Correct.]
#ans[$40:50:70$ rice $= 2 : 3 : 3$]]

#ex(37, tier: 3, asked: "Uber · pattern")[A driver wants to average 60 km/h over a 60 km round trip, 30 km each way. He drives the first 30 km at 30 km/h. What speed must he use on the return leg?
#sol[*Insight: an average speed target is really a time budget. Check the budget before doing any algebra.*
...
#ans[Impossible — no finite speed works]]

#ex(38, tier: 3, asked: "Google · pattern")[Seven *distinct* positive integers have a median of 12 and a mean of 15. What is the largest the biggest value can be?
#sol[*Insight: with seven sorted values the median pins the 4th value. Everything below it and the two values just above it must be pushed as low as the rules allow, and whatever is left goes to the 7th.*
...
#key[
*1.* 195. The total is $20 times 15 = 300$. The other fourteen must be distinct positive integers, so their smallest possible sum is $1 + 2 + ... + 14 = (14 times 15)/2 = 105$. The biggest value is then $300 - 105 = 195$, which is larger than 14, so the set is valid.

*2.* 19 students. Total $= 70 times 40 = 2800$. If $k$ students score at most 39, the largest total the class can reach is $39k + 100(40 - k) = 4000 - 61k$. This must be at least 2800, so $61k <= 1200$ and $k <= 19.67$, giving $k <= 19$. Now build a class that reaches 19. Give 19 students 39 marks each: $19 times 39 = 741$. The other $40 - 19 = 21$ students must supply $2800 - 741 = 2059$ marks. Give 20 of them 100 marks each $= 2000$, and the last one $2059 - 2000 = 59$ marks. Every score is a whole number from 0 to 100, the total is $741 + 2000 + 59 = 2800$, and exactly 19 students are below 40 (59 is not). So 19 is reached.

*3.* 4 cycles. Fraction kept each cycle $= 1 - 25/200 = 0.875$. Glycerin after $n$ cycles $= 200 times (0.875)^n$: 175.0, then 153.1, then 134.0, then 117.2. The first value below 120 comes on cycle 4. Note that cycle 3 leaves 134 L, so stopping at 3 is the trap.

*4.* Up 25%. Multiply the growth factors: $1.25 times 0.80 times 1.25$. First $1.25 times 0.80 = 1.00$, then $1.00 times 1.25 = 1.25$. So the value is 1.25 times the start, a 25% rise. Adding the percents would wrongly give $+30%$.

*5.* 30. Sum of 1 to 60 $= (60 times 61)/2 = 1830$. Multiples of 4 up to 60 are $4, 8, ..., 60$, that is 15 numbers summing to $4 times (15 times 16)/2 = 4 times 120 = 480$. What is left: sum $= 1830 - 480 = 1350$ over $60 - 15 = 45$ tokens, so $1350 div 45 = 30$.

*6.* $2 : 4 : 3$. Fuse the first two in $1 : 2$: cost $= (1 times 80 + 2 times 95)/3 = 270/3 = 90$. Alligate 90 against 120 at mean 100: $(120 - 100) : (100 - 90) = 20 : 10 = 2 : 1$. The fused part is 2 units but splits in $1 : 2$, which sums to 3, so multiply everything by 3: fused $= 6$ units splitting as 2 and 4, and the third grade $= 3$ units. Check: $(2 times 80 + 4 times 95 + 3 times 120)/9 = (160 + 380 + 360)/9 = 900/9 = 100$.
...
*8.* 85. Sum $= 25 times 6 = 150$. With six values the median is the average of the 3rd and 4th, so $a_3 + a_4 = 40$ with $a_3 < a_4$. To leave the most for $a_6$, make $a_4$ as small as possible: $a_3 = 19$ and $a_4 = 21$. Then $a_1 = 1$, $a_2 = 2$ and $a_5 = 22$. Used $= 1 + 2 + 19 + 21 + 22 = 65$, so $a_6 = 150 - 65 = 85$. Check $1, 2, 19, 21, 22, 85$: distinct, median $= (19 + 21)/2 = 20$, sum $= 150$.
]
...
*3.* 28. Old sum $= 228$; the remaining five sum to $40 times 5 = 200$; removed $= 228 - 200$. \
*4.* 35%. Acid $= 0.20 times 15 + 0.44 times 25 = 3 + 11 = 14$ litres in 40 litres, and $14/40 = 0.35$. \
*5.* 40 km/h. Equal distances, so $3 div (1/30 + 1/40 + 1/60) = 3 div (4 + 3 + 2)/120 = 3 times 120/9$. \
*6.* 40.5 litres. $72 times (1 - 18/72)^2 = 72 times (0.75)^2 = 72 times 0.5625$. \
...
*15.* 1,220. Total $= 2000$; the other 39 are at least $1 + 2 + ... + 39 = (39 times 40)/2 = 780$; $2000 - 780 = 1220$. \
*16.* 10 litres. Milk $= 42$ L, water $= 18$ L; for $3 : 2$ the water must be $42 times 2/3 = 28$ L. \
*17.* 19 years. Old sum $= 450$; new sum $= 40 times 16 = 640$; the ten newcomers total 190, so their average is 19. \
*18.* 60 km/h. $(2 times 50 times 75)/(50 + 75) = 7500/125$.
]

#revision[
*THE ONE MOVE THAT SOLVES MOST QUESTIONS* \
Sum $=$ average $times$ count. Convert every average in the question into a sum, do the adding and subtracting on sums, then divide once at the end.
...
Add $c$ to every value $arrow.r$ average $+ c$. Multiply every value by $c$ $arrow.r$ average $times c$.
