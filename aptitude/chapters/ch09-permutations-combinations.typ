...
#chapter(num: 9, title: "Permutations & Combinations", tagline: "Count without listing. Order first, then choose.")[
...
- $""^n C_r = ""^n C_(n-r)$ #h(10pt) $""^n C_0 = ""^n C_n = 1$ #h(10pt) $""^n C_1 = n$
- $""^n C_2 = (n(n-1))/2$ #h(10pt) $""^n C_3 = (n(n-1)(n-2))/6$
- $""^n C_r + ""^n C_(r-1) = ""^(n+1) C_r$ (Pascal)
- $""^n C_0 + ""^n C_1 + dots.c + ""^n C_n = 2^n$ #h(10pt) so: subsets of an $n$-set $= 2^n$; at least one item $= 2^n - 1$
...
Rectangles in a grid of $a times b$ cells $= ""^(a+1) C_2 times ""^(b+1) C_2$.

*Grid paths.* $m$ steps east and $n$ steps north: $(m+n)!/(m! n!)$.

*Sum of all numbers* formed by $n$ distinct non-zero digits, all $n$ used:
$ "Sum" = (n-1)! times ("sum of digits") times underbrace(1 1 1 dots.c 1, n "ones") $
]
...
$5!/3! = (5 times 4 times 3!)/(3!) = 5 times 4 = 20$.
]
#ans[720, 1, 20]
]
...
$= 8 times 7 times 6 = 56 times 6 = 336$.
]
#ans[336]
]
...
Find $""^10 C_3$.
#sol[
$""^10 C_3 = (10 times 9 times 8)/(3 times 2 times 1) = 720/6 = 120$.
]
#ans[120]
]
...
$""^12 C_2 = (12 times 11)/2 = 132/2 = 66$.
]
#ans[66]
]

#trick[
Never compute $""^n C_r$ with $r$ bigger than $n/2$. Flip it first: $""^20 C_17 = ""^20 C_3 = (20 times 19 times 18)/6 = 1140$. Three multiplications instead of seventeen.
]
...
(b) Every slot has all 5 letters available. $5 times 5 times 5 = 125$.
]
#ans[(a) 60 #h(6pt) (b) 125]
]
...
$"Arrangements" = 5!/(2! dot 2!) = 120/(2 times 2) = 120/4 = 30$.
]
#ans[30]
]
...
$""^7 P_4 = 7 times 6 times 5 times 4$.

$7 times 6 = 42$. $42 times 5 = 210$. $210 times 4 = 840$.
]
#ans[840]
]
...
Men: $""^5 C_3 = ""^5 C_2 = (5 times 4)/2 = 10$.

Women: $""^4 C_2 = (4 times 3)/2 = 6$.

Men AND women $arrow.r$ multiply: $10 times 6 = 60$.
]
#ans[60]
]
...
$""^5 C_3 times ""^6 C_1 = 10 times 6 = 60$.
($""^5 C_3 = ""^5 C_2 = (5 times 4)/2 = 10$.)

*Case B — 4 women, 0 men:*
$""^5 C_4 times ""^6 C_0 = 5 times 1 = 5$.
...
#trap[
"At least 3" is *not* $""^5 C_3 times ""^8 C_1$. That kind of shortcut counts the same committee more than once. Always split "at least" into clean, separate cases and add.
]
...
$6!/(3! dot 2!) = 720/(6 times 2) = 720/12 = 60$.
...
#h(10pt) $\_ #h(3pt) C #h(3pt) \_ #h(3pt) C #h(3pt) \_ #h(3pt) C #h(3pt) \_ #h(3pt) C #h(3pt) \_$

*Step 3 — put the 3 vowels into 3 different gaps.* Order matters, so
$""^5 P_3 = 5 times 4 times 3 = 60$.

Total $= 24 times 60 = 1440$.
]
#ans[1440]
]
...
$""^12 P_2 = 12 times 11 = 132$.
]
#ans[(a) 66 #h(6pt) (b) 132]
]
...
#sol[
Join any 2 of the 12 vertices: $""^12 C_2 = (12 times 11)/2 = 66$ line segments.

Of these, 12 are the sides of the polygon, not diagonals.

Diagonals $= 66 - 12 = 54$.

(Formula check: $(n(n-3))/2 = (12 times 9)/2 = 108/2 = 54$. Matches.)
]
#ans[54]
]
...
All choices: $""^10 C_3 = (10 times 9 times 8)/6 = 720/6 = 120$.
...
#key[
*1.* 210 — $7 times 6 times 5$. #linebreak()
*2.* 105 — flip: $""^15 C_13 = ""^15 C_2 = (15 times 14)/2$. #linebreak()
*3.* 504 — $9 times 8 times 7$; no zero is available so no first-digit problem. #linebreak()
*4.* 456976 — repetition allowed: $26^4$. #linebreak()
*5.* 420 — 7 letters, S three times, C twice: $5040/(6 times 2)$. #linebreak()
*6.* 34650 — 11 letters: I four times, S four times, P twice: $39916800/(24 times 24 times 2) = 39916800/1152$. #linebreak()
*7.* 126 — $""^9 C_4 = (9 times 8 times 7 times 6)/24 = 3024/24$. #linebreak()
*8.* 210 — $""^4 C_2 times ""^7 C_3 = 6 times 35$. "Exactly 2 women" fixes the men count at 3. #linebreak()
*9.* 120 — $(6-1)! = 5! = 120$. Answer 720 means you forgot it is circular. #linebreak()
*10.* 10 — $(n(n-1))/2 = 45 arrow.r n(n-1) = 90 arrow.r n = 10$. #linebreak()
*11.* 20 — $(8 times 5)/2$. #linebreak()
*12.* 360 — vowels O, A, E: 3 choices for the first letter, then $5! = 120$ for the rest. #linebreak()
*13.* 720 — glue: 5 units $arrow.r 5! = 120$, times $3! = 6$ inside. #linebreak()
*14.* 63 — $2^6 - 1 = 64 - 1$. #linebreak()
...
#trap[
In a circular "together" problem you glue first and *then* apply $(k-1)!$ to the new number of units. Writing $(8-1)!$ and then gluing gives $7! times 2 = 10080$, which is larger than the total. If a sub-count comes out bigger than the total, you glued in the wrong order.
]
...
#h(10pt) $L #h(3pt) | #h(3pt) L #h(3pt) | #h(3pt) L dots.c L$

Put 3 dividers into 3 of the 11 gaps. That cuts the row into 4 non-empty parts.

$""^11 C_3 = (11 times 10 times 9)/(3 times 2 times 1) = 990/6 = 165$.
]
#ans[165]
]
...
$""^13 C_3 = (13 times 12 times 11)/6 = 1716/6 = 286$.

(b) First hand out the compulsory 2 vouchers to each rider: $4 times 2 = 8$ used.

Vouchers left $= 10 - 8 = 2$, now free to give to anyone.

$y_1+y_2+y_3+y_4 = 2$ with each $y_i gt.eq 0$:
$""^(2+4-1) C_3 = ""^5 C_3 = ""^5 C_2 = (5 times 4)/2 = 10$.
]
#ans[(a) 286 #h(6pt) (b) 10]
]
...
$""^12 C_4 = (12 times 11 times 10 times 9)/24 = 11880/24 = 495$.

$""^8 C_4 = (8 times 7 times 6 times 5)/24 = 1680/24 = 70$.

$""^4 C_4 = 1$.

Total $= 495 times 70 times 1 = 34650$.

(b) Without names, the same 3 sets can be labelled in $3! = 6$ orders, and all 6 were counted separately above.

$34650/6 = 5775$.
]
#ans[(a) 34650 #h(6pt) (b) 5775]
]
...
#ex(27, tier: 2, asked: "Agoda · pattern")[
...
$8!/(5! dot 3!) = 40320/(120 times 6) = 40320/720 = 56$.
...
$9 times 8 = 72$. $72 times 7 = 504$. $504 times 6 = 3024$. $3024 times 5 = 15120$.

Total $= 9 times 15120 = 136080$.
]
#ans[136080]
]

#ex(29, tier: 2, asked: "Sea/Shopee · pattern")[
...
*Case A — 2 SG, 3 TH:*
$""^6 C_2 = (6 times 5)/2 = 15$. $""^5 C_3 = ""^5 C_2 = (5 times 4)/2 = 10$.
$15 times 10 = 150$.

*Case B — 3 SG, 2 TH:*
$""^6 C_3 = (6 times 5 times 4)/6 = 120/6 = 20$. $""^5 C_2 = 10$.
$20 times 10 = 200$.
...
#h(10pt) $\_ #h(3pt) e #h(3pt) \_ #h(3pt) e #h(3pt) \_ #h(3pt) e #h(3pt) \_ #h(3pt) e #h(3pt) \_ #h(3pt) e #h(3pt) \_$

*Step 2 — choose 4 of the 6 gaps* (one rider per gap keeps them apart):
$""^6 C_4 = ""^6 C_2 = (6 times 5)/2 = 15$.

*Step 3 — the riders are different people, so order them:* $4! = 24$.

Total $= 15 times 24 = 360$.

(Formula check: $""^(n-r+1) C_r times r! = ""^6 C_4 times 4! = 360$. Matches.)
]
#ans[360]
]
...
#key[
*1.* 720 — glue the 3: units $= 5 + 1 = 6$, circular $arrow.r 5! = 120$, times $3! = 6$. #linebreak()
*2.* 1001 — $""^14 C_4 = (14 times 13 times 12 times 11)/24 = 24024/24$. #linebreak()
*3.* 36 — zero allowed: $""^(7+3-1) C_2 = ""^9 C_2 = 36$. #linebreak()
*4.* 70 — $8!/(4! 4!) = 40320/576$. #linebreak()
*5.* 560 — $""^8 C_3 times ""^5 C_3 = 56 times 10$. The two shifts are different, so do not divide by $2!$. #linebreak()
*6.* 120 — the 2 are fixed, pick 3 more from 10: $""^10 C_3$. #linebreak()
*7.* 5040 — order matters: $""^10 P_4 = 10 times 9 times 8 times 7$. #linebreak()
*8.* 126 — $""^10 C_5 = 252$, then divide by $2!$ because the groups are unnamed. #linebreak()
*9.* 243 — $3^5$. #linebreak()
*10.* 60 — 4 empty seats give 5 gaps: $""^5 C_3 times 3! = 10 times 6$. #linebreak()
*11.* 12 — glue: 4 units circular $arrow.r 3! = 6$, times $2! = 2$. #linebreak()
*12.* 48 — last digit must be 2 or 4 (2 ways), then $4 times 3 times 2 = 24$ for the first three places: $2 times 24$.
]
...
Term by term:
- $5! = 120$
- $""^5 C_1 times 4! = 5 times 24 = 120$
- $""^5 C_2 times 3! = 10 times 6 = 60$
- $""^5 C_3 times 2! = 10 times 2 = 20$
- $""^5 C_4 times 1! = 5 times 1 = 5$
- $""^5 C_5 times 0! = 1 times 1 = 1$
...
$""^7 C_3 = (7 times 6 times 5)/(3 times 2 times 1) = 210/6 = 35$.
...
So $D_4 = 24 times 9/24 = 9$.

*Step 3 — multiply:* $35 times 9 = 315$.
]
#ans[315]
]

#trap[
If Step 2 were "$4!$" you would be allowing some of those 4 to also be correct, and the count would include cases with 4, 5, 6 or 7 correct letters. "Exactly $k$" always forces a derangement on the rest: $""^n C_k times D_(n-k)$.
]
...
#ex(34, tier: 3, asked: "Google · pattern")[
...
Sum contributed by the units place $= 6 times 17 = 102$.
Tens place $= 102 times 10$. Hundreds $= 102 times 100$. Thousands $= 102 times 1000$.

$ "Total" = 102 times (1 + 10 + 100 + 1000) = 102 times 1111 $

$102 times 1111 = 102 times 1000 + 102 times 100 + 102 times 10 + 102 = 102000 + 10200 + 1020 + 102 = 113322$.
...
Sum $= (n-1)! times ("sum of digits") times (underbrace(1 1 dots.c 1, n))$.
For 4 digits the repunit is $1111$; for 3 digits it is $111$.
]

#ex(35, tier: 3, asked: "Microsoft · pattern")[
An $8 times 8$ chessboard is drawn.
...
(a) An $8 times 8$ board of cells is made of 9 vertical lines and 9 horizontal lines.

Choose 2 vertical lines: $""^9 C_2 = (9 times 8)/2 = 36$.
Choose 2 horizontal lines: $""^9 C_2 = 36$.

Rectangles $= 36 times 36 = 1296$.

(b) A $k times k$ square needs its top-left corner in a $(9-k) times (9-k)$ block of positions, so there are $(9-k)^2$ squares of side $k$.
...
#ans[(a) 1296 rectangles #h(6pt) (b) 204 squares]
]
...
$""^18 C_3 = (18 times 17 times 16)/(3 times 2 times 1) = 4896/6 = 816$.
...
#h(10pt) $1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1 #h(4pt) 1$
...
+ How many squares are there in a $6 times 6$ grid of cells?
+ How many 5-digit numbers have their digits in strictly increasing order?
]

#key[
*1.* *265.* This is $D_6$. Using $D_n = (n-1)(D_(n-1) + D_(n-2))$ with $D_4 = 9$ and $D_5 = 44$: $D_6 = 5(44 + 9) = 5 times 53 = 265$. The recurrence is far faster than the full inclusion–exclusion sum, and worth memorising up to $D_6$. #linebreak()
*2.* *20.* Choose which 2 are correct: $""^5 C_2 = 10$. The remaining 3 must all be wrong: $D_3 = 2$. So $10 times 2 = 20$. Using $3!$ instead of $D_3$ gives 60, which wrongly includes cases with more than 2 correct. #linebreak()
*3.* *540.* Free count $3^6 = 729$. Subtract the ones missing a box: $""^3 C_1 times 2^6 = 3 times 64 = 192$. Add back the ones using a single box: $""^3 C_2 times 1^6 = 3$. $729 - 192 + 3 = 540$. #linebreak()
*4.* *10656.* Total numbers $= ""^4 P_3 = 24$. Each of the 4 digits appears $24/4 = 6$ times in each of the 3 places. Sum of digits $= 1+3+5+7 = 16$, so each place contributes $6 times 16 = 96$. Total $= 96 times 111 = 10656$. #linebreak()
*5.* *495.* Shrink: subtract 0, 1, 2, 3 from the four chosen numbers in order, giving 4 distinct values in the range 1 to $15 - 3 = 12$. So $""^12 C_4 = (12 times 11 times 10 times 9)/24 = 11880/24 = 495$. #linebreak()
*6.* *231.* All solutions: $""^15 C_3 = 455$. Bad ones with a chosen variable $gt.eq 7$: substitute and get a total of 5, giving $""^8 C_3 = 56$ each, and there are 4 variables: $4 times 56 = 224$. Two variables cannot both be $gt.eq 7$ since $14 > 12$, so nothing is added back. $455 - 224 = 231$. #linebreak()
*7.* *91.* Squares of side $k$ number $(7-k)^2$: $36 + 25 + 16 + 9 + 4 + 1 = 91$. (Rectangles would be $""^7 C_2 times ""^7 C_2 = 441$.) #linebreak()
*8.* *126.* Once you choose 5 different digits, exactly one increasing order exists — so this is a pure selection. The digit 0 can never be used, because in an increasing number it would have to come first. So choose 5 from $1..9$: $""^9 C_5 = ""^9 C_4 = (9 times 8 times 7 times 6)/24 = 3024/24 = 126$.
]
...
#key[
*1.* 72 — $9 times 8$. #linebreak()
*2.* 2520 — 7 letters, C twice: $5040/2$. #linebreak()
*3.* 40 — $""^5 C_2 times ""^4 C_1 = 10 times 4$. #linebreak()
*4.* 6 — $(4-1)! = 3!$. #linebreak()
*5.* 648 — first digit 9 ways (not 0), then $9 times 8$: $9 times 9 times 8$. #linebreak()
*6.* 969 — $""^19 C_3 = (19 times 18 times 17)/6 = 5814/6$. #linebreak()
*7.* 90 — $(15 times 12)/2$. #linebreak()
*8.* 121 — all $""^9 C_4 = 126$, minus all-men $""^5 C_4 = 5$. #linebreak()
*9.* 1855 — $""^7 C_1 times D_6 = 7 times 265$. #linebreak()
*10.* 210 — $10!/(6! 4!) = ""^10 C_4$. #linebreak()
*11.* 1679616 — 36 symbols, 4 slots: $36^4$. #linebreak()
*12.* 277200 — 11 letters: E three times, N three times, G twice, I twice. $39916800/(6 times 6 times 2 times 2) = 39916800/144$. #linebreak()
*13.* 3276 — $""^(30-3+1) C_3 = ""^28 C_3 = (28 times 27 times 26)/6 = 19656/6$. #linebreak()
*14.* 243 — each of the 5 distinct prizes picks a student: $3^5$. #linebreak()
*15.* 15 — $2^4 - 1$. #linebreak()
*16.* 72 — total $5! = 120$; together $= 4! times 2 = 48$; $120 - 48$. #linebreak()
*17.* 2664 — 6 numbers; each digit appears $6/3 = 2$ times per place; digit sum $= 12$; $2 times 12 = 24$ per place; $24 times 111$. #linebreak()
*18.* 462 — $""^12 C_6 = 924$, divided by $2!$ for unnamed groups. #linebreak()
*19.* 120 — $""^5 P_4 = 5 times 4 times 3 times 2$. #linebreak()
*20.* 10 — $5!/(3! 2!) = 120/12$.
]
...
[Necklace], [$(n-1)!/2$],
[Group together], [glue $arrow.r (k)! times ("units arrangement")$],
[No two together ($r$ of $n$ in a row)], [$""^(n-r+1) C_r$, then $times r!$ if distinct],
...
[Rectangles in $a times b$ cells], [$""^(a+1) C_2 times ""^(b+1) C_2$],
[Derangement], [$D_n = (n-1)(D_(n-1)+D_(n-2))$],
[Exactly $k$ correct out of $n$], [$""^n C_k times D_(n-k)$],
[Sum of all numbers, $n$ distinct digits], [$(n-1)! times ("digit sum") times 1 1 dots 1$],
)
