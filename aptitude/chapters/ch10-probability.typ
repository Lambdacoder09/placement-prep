...
#chapter(num: 10, title: "Probability", tagline: "Count the good cases. Divide. Then check the condition.")[
...
$ P(E) = P(B_1) P(E bar B_1) + P(B_2) P(E bar B_2) + dots.c $

*Bayes' theorem.* (Cause given effect.)
$ P(B_i bar E) = (P(B_i) P(E bar B_i))/(sum_j P(B_j) P(E bar B_j)) $
...
#sol[
(a) Independent $arrow.r$ multiply. $P(A inter B) = 0.6 times 0.5 = 0.30$.

(b) $P("not" A) = 1 - 0.6 = 0.4$ and $P("not" B) = 1 - 0.5 = 0.5$.
$P("neither") = 0.4 times 0.5 = 0.20$.
]
#ans[(a) 0.30 #h(6pt) (b) 0.20]
]
...
Total ways to draw 2 $= ""^12 C_2 = (12 times 11)/2 = 66$.

(a) Both red: $""^4 C_2 = (4 times 3)/2 = 6$.
$P = 6/66 = 1/11$.

(b) One red and one green: $""^4 C_1 times ""^5 C_1 = 4 times 5 = 20$.
$P = 20/66 = 10/33$.
]
#ans[(a) $1/11$ #h(6pt) (b) $10/33$]
]

#trick[
*Two balls drawn together = draw them one by one.* For "both red" you may also write
$4/12 times 3/11 = 12/132 = 1/11$ — the same answer, with no $""^n C_r$ at all.

For a *mixed* pair like "one red and one green" you must allow both orders:
$4/12 times 5/11 + 5/12 times 4/11 = 20/132 + 20/132 = 40/132 = 10/33$.
...
(a) $P("both fail") = 2/3 times 3/4 = 6/12 = 1/2$.
$P("solved") = 1 - 1/2 = 1/2$.

(b) Anjali solves and Bhavin fails: $1/3 times 3/4 = 3/12$.
Bhavin solves and Anjali fails: $2/3 times 1/4 = 2/12$.

These two cases cannot happen together, so add:
$3/12 + 2/12 = 5/12$.
]
#ans[(a) $1/2$ #h(6pt) (b) $5/12$]
]
...
#sol[
Total bulbs $= 10$. Total ways $= ""^10 C_3 = (10 times 9 times 8)/6 = 720/6 = 120$.

(a) All 3 good: $""^6 C_3 = (6 times 5 times 4)/6 = 120/6 = 20$.
$P = 20/120 = 1/6$.

(b) 1 defective and 2 good: $""^4 C_1 times ""^6 C_2 = 4 times 15 = 60$.
$P = 60/120 = 1/2$.
]
#ans[(a) $1/6$ #h(6pt) (b) $1/2$]
]

#ex(18, tier: 1, asked: "Wipro pattern")[
Find the probability that (a) an ordinary year has 53 Sundays, (b) a leap year has 53 Sundays.
#sol[
(a) An ordinary year has 365 days. $365 = 52 times 7 + 1$.
...
(b) A leap year has 366 days. $366 = 52 times 7 + 2$.
...
#ex(20, tier: 1, asked: "Capgemini pattern")[
...
Ravi truth AND Sita lie: $0.75 times 0.20 = 0.15$.
Ravi lie AND Sita truth: $0.25 times 0.80 = 0.20$.
...
#key[
*1.* $1/2$ — primes on a die are 2, 3, 5 $arrow.r 3/6$. (1 is not prime; answering $2/3$ means you counted it.) #linebreak()
*2.* $1/9$ — $(3,6),(4,5),(5,4),(6,3) arrow.r 4/36$. #linebreak()
*3.* $11/13$ — 4 kings $+$ 4 queens $= 8$ excluded; $44/52$. #linebreak()
*4.* $2/5$ — $4/10$. #linebreak()
*5.* $1/4$ — only TT out of 4 outcomes. #linebreak()
*6.* $1/4$ — $""^4 C_3 = 4$ out of $2^4 = 16$. #linebreak()
*7.* 0.58 — $0.4 + 0.3 - (0.4 times 0.3) = 0.7 - 0.12$. Answering 0.7 means you treated them as mutually exclusive. #linebreak()
*8.* $1/4$ — 4, 8, 12, 16, 20 $arrow.r 5/20$. #linebreak()
*9.* $7/22$ — $""^7 C_2 \/ ""^12 C_2 = 21/66$. #linebreak()
*10.* $1/6$ — 6 doublets out of 36. #linebreak()
*11.* $7/15$ — multiples of 3: 5; of 5: 3; of 15: 1. $5 + 3 - 1 = 7$. #linebreak()
*12.* 0.3 — $P(A inter B) = 0.5 + 0.6 - 0.8$. #linebreak()
*13.* $3/4$ — $P("none") = 1/2 times 2/3 times 3/4 = 6/24 = 1/4$; answer $= 1 - 1/4$. #linebreak()
*14.* $3/26$ — 6 red face cards out of 52. #linebreak()
...
$P(C) = 0.60$, $P(S) = 0.40$.
$P(F bar C) = 0.90$, $P(F bar S) = 0.70$, where $F$ = finished in 20 min.

Total probability:
$ P(F) = P(C) P(F bar C) + P(S) P(F bar S) $

$= 0.60 times 0.90 + 0.40 times 0.70$
...
$ P(C bar F) = (P(C) P(F bar C))/(P(F)) $

Numerator $= 0.60 times 0.90 = 0.54$ (computed in Example 21).
Denominator $= 0.82$.

$P(C bar F) = 0.54/0.82 = 54/82 = 27/41$.

As a decimal: $27 div 41 = 0.6585dots approx 0.659$.
]
#ans[$27/41 approx 0.659$]
]

#trick[
Bayes is just a two-line table. Write down the product $P("cause") times P("effect" bar "cause")$ for each cause, add the column to get $P("effect")$, then divide the row you want by that total. You never need to recall the full formula.
#table(columns: 4,
[*Cause*],[*Prior*],[$P(F bar dot)$],[*Product*],
[City],[0.60],[0.90],[0.54],
...
#sol[
$P(A) = 0.70$, $P(D bar A) = 0.02 arrow.r$ product $= 0.70 times 0.02 = 0.014$.

$P(B) = 0.30$, $P(D bar B) = 0.05 arrow.r$ product $= 0.30 times 0.05 = 0.015$.

$P(D) = 0.014 + 0.015 = 0.029$.

$0.029 = 2.9%$.
]
#ans[0.029, that is 2.9%]
]

#ex(24, tier: 2, asked: "Shopee · pattern")[
Continuing Example 23: an order arrives damaged. Find the probability that it came from warehouse B.
#sol[
$ P(B bar D) = (P(B) P(D bar B))/(P(D)) = 0.015/0.029 $

Multiply top and bottom by 1000: $15/29$.

$15 div 29 = 0.5172dots approx 0.517$.
]
#ans[$15/29 approx 0.517$]
]
...
#ex(25, tier: 2, asked: "DBS · pattern")[
...
$E = 50 times 0.02 + 10 times 0.10 + 0 times 0.88$

$= 1.00 + 1.00 + 0 = 2.00$, that is S\$2.00 per customer.

(b) Expected total $= 5000 times 2.00 = 10000$, that is S\$10,000.
]
#ans[(a) S\$2 per customer #h(6pt) (b) S\$10,000]
]

#ex(26, tier: 2, asked: "Agoda · pattern")[
...
*Piece 1:* $""^8 C_2 = (8 times 7)/2 = 28$.

*Piece 2:* $(0.15)^2 = 0.0225$.

*Piece 3:* $(0.85)^6$.
$0.85^2 = 0.7225$.
$0.85^3 = 0.7225 times 0.85 = 0.614125$.
$0.85^6 = (0.85^3)^2 = 0.614125 times 0.614125 = 0.377150$ (to 6 places).

*Multiply:* $28 times 0.0225 = 0.63$.
$0.63 times 0.377150 = 0.237604$.
]
#ans[$approx 0.2376$, that is about 23.8%]
]
...
*Exactly 2:* $""^3 C_2 (0.6)^2 (0.4)^1 = 3 times 0.36 times 0.4$.
$3 times 0.36 = 1.08$. $1.08 times 0.4 = 0.432$.

*Exactly 3:* $""^3 C_3 (0.6)^3 = 1 times 0.216 = 0.216$.
($0.6^2 = 0.36$, $0.36 times 0.6 = 0.216$.)
...
#ex(28, tier: 2, asked: "GIC · pattern")[
...
Total ways to pick 3 of 12: $""^12 C_3 = (12 times 11 times 10)/6 = 1320/6 = 220$.

No junk bond means all 3 come from the 8 good bonds:
$""^8 C_3 = (8 times 7 times 6)/6 = 336/6 = 56$.
...
#ans[$41/55 approx 0.745$]
]

#ex(29, tier: 2, asked: "LINE MAN · pattern")[
...
#sol[
(a) Binomial mean $= n p = 4 times 0.2 = 0.8$ deliveries.

(b) $P("one delivery not late") = 1 - 0.2 = 0.8$.

$P("none late") = 0.8^4$.
$0.8^2 = 0.64$. $0.8^4 = 0.64 times 0.64 = 0.4096$.

$P("at least one late") = 1 - 0.4096 = 0.5904$.
]
#ans[(a) 0.8 #h(6pt) (b) 0.5904]
]

#ex(30, tier: 2, asked: "Razer · pattern")[
...
$7/8 times 7/8 times 1/8 = 49/512$.

$49 div 512 = 0.0957$.
]
#ans[(a) 8 boxes #h(6pt) (b) $49/512 approx 0.0957$]
]
...
+ $P(A) = 0.3$ and $P(B bar A) = 0.5$. Find $P(A inter B)$.
...
#key[
*1.* 0.042 — $0.6 times 0.03 = 0.018$ and $0.4 times 0.06 = 0.024$; add. #linebreak()
*2.* $3/7 approx 0.4286$ — $0.018 \/ 0.042$. Answering 0.6 means you reported the prior instead of the posterior. #linebreak()
*3.* $1/17$ — 3 kings remain among 51 cards: $3/51$. #linebreak()
*4.* $1/10$ — $""^2 C_2 \/ ""^5 C_2 = 1/10$. #linebreak()
*5.* $-$Rs.~2 — expected payout $= 60 times 1/6 = 10$; profit $= 10 - 12 = -2$, so an expected loss of Rs.~2 per game. #linebreak()
*6.* $15/64$ — $""^6 C_4 \/ 2^6 = 15/64$. #linebreak()
*7.* 0.15 — $P(A) times P(B bar A) = 0.3 times 0.5$. #linebreak()
*8.* $7/15$ — $""^3 C_1 times ""^7 C_1 \/ ""^10 C_2 = 21/45$. #linebreak()
*9.* 0.91854 — none late $= 0.9^5 = 0.59049$; exactly one $= 5 times 0.1 times 0.9^4 = 5 times 0.1 times 0.6561 = 0.32805$; add. #linebreak()
*10.* 3.5 — $(1+2+3+4+5+6)\/6 = 21/6$. #linebreak()
*11.* $27/128 approx 0.211$ — $""^4 C_2 (1/4)^2 (3/4)^2 = 6 times 1/16 times 9/16 = 54/256$. #linebreak()
*12.* $7/15$ — $1/2 times 3/5 + 1/2 times 2/6 = 3/10 + 1/6 = 9/30 + 5/30 = 14/30$. The boxes hold different totals, so you cannot pool the balls.
]
...
$P(T bar D) = 0.99$, $P(T bar "no" D) = 0.04$.

*True positives:* $0.005 times 0.99 = 0.00495$.

*False positives:* $0.995 times 0.04 = 0.0398$.

*All positives:* $P(T) = 0.00495 + 0.0398 = 0.04475$.

$ P(D bar T) = 0.00495/0.04475 $
...
#ex(32, tier: 3, asked: "Google · pattern")[
...
$12 times 11 = 132$. $132 times 10 = 1320$. $1320 times 9 = 11880$. $11880 times 8 = 95040$.

$ P("all different") = 95040/248832 = 0.381944dots $

$ P("at least two share") = 1 - 0.381944 = 0.618056 $
]
#ans[$approx 0.618$, that is about 61.8%]
]

#ex(33, tier: 3, asked: "Amazon · pattern")[
...
$ P(X_i = 1) = 1/5 quad arrow.r quad E[X_i] = 1 times 1/5 + 0 times 4/5 = 1/5 $

By linearity:
$ E[X] = E[X_1] + dots.c + E[X_5] = 5 times 1/5 = 1 $
...
$(0 times 44 + 1 times 45 + 2 times 20 + 3 times 10 + 4 times 0 + 5 times 1)/120 = (45 + 40 + 30 + 0 + 5)/120 = 120/120 = 1$. Matches.
]
#ans[1 letter, on average]
]
...
#ans[(a) 6 rolls #h(6pt) (b) 6 more rolls]
]

#ex(35, tier: 3, asked: "Microsoft · pattern")[
...
(General form: $E = n(1 + 1/2 + dots.c + 1/n)$. Here $3(1 + 1/2 + 1/3) = 3 times 11/6 = 5.5$.)
]
#ans[5.5 packets]
]
...
Whole run: $1000 times 25 = 25000$, that is Rs.~25,000.

(Check by totals: revenue $= 1000 times 60 = 60000$; prizes $= 35000$; profit $= 60000 - 35000 = 25000$. Matches.)
]
#ans[(a) Rs.~35 #h(6pt) (b) Rs.~25,000]
]
...
If both miss — probability $1/2 times 1/2 = 1/4$ — the position is exactly the starting position, with Priya to toss. Her chance from there is again $p$.

$ p = 1/2 + 1/4 p $

$ p - 1/4 p = 1/2 arrow.r 3/4 p = 1/2 arrow.r p = 1/2 times 4/3 = 2/3 $
...
#key[
*1.* *$approx 8.76%$.* True positives $= 0.01 times 0.95 = 0.0095$. False positives $= 0.99 times 0.10 = 0.099$. All positives $= 0.1085$. Answer $= 0.0095 \/ 0.1085 = 0.08756$. In 100,000 people: 950 true positives against 9,900 false ones — the healthy group is 99 times larger, so its 10% error rate swamps the test's 95% hit rate. #linebreak()
*2.* *$approx 0.4271$.* All different $= (12 times 11 times 10 times 9)\/12^4 = 11880/20736 = 0.572917$. Answer $= 1 - 0.572917 = 0.427083$. Note how fast this grows: 5 people already gave 0.618 in Example 32. #linebreak()
*3.* *2.25.* Use indicators. There are 9 adjacent pairs. For each pair, $P("both heads") = 1/2 times 1/2 = 1/4$. By linearity $E = 9 times 1/4 = 9/4 = 2.25$. The pairs overlap and are dependent, which does not matter for expectation. #linebreak()
*4.* *3 rolls.* "Greater than 4" means 5 or 6, so $p = 2/6 = 1/3$. Waiting for a first success gives $E = 1\/p = 3$. #linebreak()
*5.* *$25/3 approx 8.33$ packets.* Stage waits are $1$, $4/3$, $4/2 = 2$ and $4/1 = 4$. Sum $= 1 + 4/3 + 2 + 4 = 7 + 4/3 = 25/3$. Equivalently $4(1 + 1/2 + 1/3 + 1/4) = 4 times 25/12$. #linebreak()
*6.* *$2/11$.* Outcomes containing at least one 3: $6 + 6 - 1 = 11$. Those summing to 8: $(3,5)$ and $(5,3)$, so 2. Answer $2/11$, not the unconditional $5/36$. #linebreak()
*7.* *$6/11$.* Let $p$ be Aarav's chance. He wins at once with probability $1/6$; with probability $5/6 times 5/6 = 25/36$ both miss and the game restarts with him to roll. So $p = 1/6 + (25/36)p arrow.r (11/36)p = 1/6 arrow.r p = 36/66 = 6/11$. Moving first is worth more than half. #linebreak()
*8.* *$3/13 approx 0.2308$.* Indicators again: let $X_i = 1$ if the $i$-th card drawn is an ace. By symmetry each drawn card is an ace with probability $4/52 = 1/13$, whatever its position. $E = 3 times 1/13 = 3/13$. "Without replacement" changes the distribution but not this expectation.
]

#section[Mixed set — exam conditions]

#practice(tier: 1, time: "90 s/Q · 30 min total")[
...
+ $P(A) = 0.6$ and $P(B bar A) = 0.25$. Find $P(A inter B)$.
...
#key[
*1.* $1/2$ — 1, 3, 5 out of 6. #linebreak()
*2.* $1/9$ — $(1,4),(2,3),(3,2),(4,1) arrow.r 4/36$. #linebreak()
*3.* $4/13$ — $4 + 13 - 1 = 16$ (the ace of spades is in both); $16/52$. #linebreak()
*4.* $13/28$ — $[""^3 C_2 + ""^5 C_2] \/ ""^8 C_2 = (3 + 10)/28$. #linebreak()
*5.* $31/32$ — $1 - (1/2)^5$. #linebreak()
*6.* 0.54 — $0.7 times 0.6 + 0.3 times 0.4 = 0.42 + 0.12$. #linebreak()
*7.* $15/29 approx 0.517$ — products $0.7 times 0.02 = 0.014$ and $0.3 times 0.05 = 0.015$; total $0.029$; take $0.015 \/ 0.029$. #linebreak()
*8.* Rs.~7 — $E[2X] = 2 E[X] = 2 times 3.5$. #linebreak()
*9.* 0.4096 — $""^5 C_1 (0.2)(0.8)^4 = 5 times 0.2 times 0.4096 = 1 times 0.4096$. #linebreak()
*10.* $2/7$ — 366 days give 2 odd days; Monday appears in 2 of the 7 consecutive-day pairs. #linebreak()
*11.* $2/5$ — total $= 5!\/(2! 2!) = 30$; starting with L leaves E, V, E, L $arrow.r 4!\/2! = 12$; $12/30$. #linebreak()
*12.* $14/55$ — $""^8 C_3 \/ ""^12 C_3 = 56/220$. #linebreak()
*13.* 5 — $n p = 30 times 1/6$. #linebreak()
*14.* 0.15 — $0.6 times 0.25$. #linebreak()
*15.* $1/2$ — sum even means both odd (9 ways) or both even (9 ways), so 18 outcomes; both odd is 9 of them. #linebreak()
*16.* $1/16$ — three tails then a head: $(1/2)^3 times 1/2$. #linebreak()
*17.* $30/49$ — $(7 times 6 times 5)\/7^3 = 210/343$. #linebreak()
*18.* $4/25$ — with replacement the draws are independent: $(4/10)^2 = 0.16$. #linebreak()
*19.* $7/11$ — odds *against* $4:7$ means 4 parts against and 7 parts for, so $P = 7/11$. Answering $4/11$ means you read "against" as "in favour". #linebreak()
*20.* $-$Rs.~5 — expected winnings $= 100 times 0.15 = 15$; profit $= 15 - 20 = -5$, an expected loss of Rs.~5.
]
...
[Multiplication], [$P(A inter B) = P(A) dot P(B bar A)$],
[Independent], [$P(A inter B) = P(A) dot P(B)$],
[Conditional], [$P(A bar B) = P(A inter B) \/ P(B)$],
)

*TOTAL PROBABILITY & BAYES* — build the table, never the formula:
#table(columns: 4,
[*Cause*],[*Prior*],[$P(E bar "cause")$],[*Product*],
[$B_1$],[$P(B_1)$],[$P(E bar B_1)$],[multiply],
[$B_2$],[$P(B_2)$],[$P(E bar B_2)$],[multiply],
[],[],[*Total* $= P(E)$],[add the column],
)
Then $P(B_i bar E) = ("its product")/("the column total")$.
...
+ *Conditioning by multiplying.* $P(A bar B)$ means shrinking the sample space to $B$ and recounting inside it. "At least one die shows a 4" gives 11 outcomes, not 6, not 12.
