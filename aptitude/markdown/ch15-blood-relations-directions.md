# Chapter 15 — Blood Relations, Directions & Ranking

*Draw the tree, draw the map, count the row*
...
**➜ Answer: 5 km, South-East of home**
...
Priya's original 14th position is not needed. Extra data is normal in this pattern.
...
**➜ Answer: Gopal is Karan's grandfather (paternal)**
...
**➜ Answer: 6 km, due West of the depot**
...
**➜ Answer: 10 km (North-East of the hub); $5 slash 14$ of the distance ridden**
...
**➜ Answer: (a) Grandson  (b) 2 grandchildren**
...
Trainees above Meera $= 36/100 \times 250 = (36 \times 250)/100 = 9000/100 = 90$. \
...
**➜ Answer: 12 km apart; Pim is due North of Wichai**
...
**(a)** [D ÷ F + E]  **(b)** [D ÷ F − E]  **(c)** [D × F + E]  **(d)** [F + E ÷ D]
...
**➜ Answer: 22nd from the back**

**Example 27** `Razer · pattern`
...
North: $12 \times 40/60 = 12 \times 2/3 = 8$ km. \
East: $16 \times 45/60 = 16 \times 3/4 = 12$ km. \
South: $9 \times 20/60 = 9 \times 1/3 = 3$ km. \
...
**➜ Answer: 13 km, North-East of base**
...
**➜ Answer: (a) Ivan is Lalit's uncle  (b) Kiran is Hari's nephew**
...
+ In a code, 'A © B' means A is the brother of B, 'A @ B' means A is the mother of B, 'A £ B' means A is the daughter of B, and 'A ¥ B' means A is the wife of B. Which expression means "P is the maternal uncle of Q"? 
**(a)** [P © R @ Q]  **(b)** [P © R £ Q]  **(c)** [P £ R @ Q]  **(d)** [R @ Q © P]
...
2. **99th from the top.** Below her $= 0.45 \times 180 = 81$, so her rank from the bottom is 82, and $180 - 82 + 1 = 99$.
3. **26 km.** East $= 24 \times 25/60 = 10$ km; North $= 18 \times 80/60 = 24$ km; $sqrt(100 + 576) = sqrt(676) = 26$.
...
Final position $= (25 \times (-2), " " 25 \times (-2)) = (-50, -50)$. \
...
**➜ Answer: $50 sqrt(2) \approx 70.7$ m South-West of the origin, facing North**
...
Arjun is not in positions 1 to 4, so Arjun's position $a \\ge 5$. \
At least 5 children between them means $b - a - 1 \\ge 5$, so $b \\ge a + 6$. \
The smallest possible $b$ comes from the smallest possible $a$: \
$a = 5$ gives $b \\ge 5 + 6 = 11$. \
...
**➜ Answer: She walked due East; she is $10 sqrt(2) \approx 14.14$ km from the start**
...
Check directly: in $0.5$ h, A covers $30 \times 0.5 = 15$ km North; B covers $40 \times 0.5 = 20$ km East. \
...
**➜ Answer: (a) 30 minutes  (b) B is South-East of A**
...
7. **24 ways.** Two people between P and Q gives $Q = P + 3$; R is three places right of Q gives $R = Q + 3 = P + 6$. With 7 places, $P \\ge 1$ and $R \\le 7$ force $P = 1$, $Q = 4$, $R = 7$. The remaining four people fill places 2, 3, 5, 6 in $4! = 24$ ways.

## Mixed set — exam conditions

#### Practice — Tier 1 — Service *(target: 25 questions in 30 min — here, 20 in 24 min)*
...
+ 'P − Q' means P is the mother of Q. 'P ÷ Q' means P is the father of Q. 'P × Q' means P is the brother of Q. Which expression shows that A is the paternal grandfather of D? 
...
6. **45 students.** Above her $= 11$; below her $= 3 \times 11 = 33$; total $= 11 + 1 + 33 = 45$.
