# Chapter 17 — Syllogisms & Logical Deduction

*Draw the circles. Never argue from the words.*
...
- All S are P $\\Rightarrow$ Some P are S.   (Never "All P are S".)
- No S is P $\\Rightarrow$ No P is S $\\Rightarrow$ Some S are not P, Some P are not S.
- Some S are P $\\Rightarrow$ Some P are S.
- Some S are not P $\\Rightarrow$ **nothing**. Cannot be flipped.
...
+ One negative statement $\\Rightarrow$ the conclusion must be negative.
+ Two "some" statements give nothing.
+ One "some" statement $\\Rightarrow$ the conclusion must be a "some" statement.
...
**➜ Answer: (b) Some blue things are pens.**
...
**➜ Answer: No dog is a cat; Some cats are not dogs.**
...
**➜ Answer: Some ripe things are mangoes.**
...
**➜ Answer: Does not follow (two "some" statements give nothing).**
...
**➜ Answer: Yes — A/O complementary pair.**
...
**Conclusions:** I. No rose is a stone.   II. Some stones are roses.
...
**Conclusions:** I. Some doctors are artists.   II. All artists are doctors.
...
**Conclusions:** I. Some tables are not beds.   II. No table is a bed.

**Solution**

Some + No $\\Rightarrow$ "Some are not". The tables that are chairs cannot be beds,
...
Rule 5: one particular premise $\\Rightarrow$ a particular conclusion.

**Example 13** `Capgemini pattern`

**Statements:** All apples are fruits. Some fruits are sweet. \
**Conclusions:** I. Some apples are sweet.   II. Some apples are not sweet.
...
**Conclusions:** I. No fan is a switch.   II. Some switches are not lights.
...
**Conclusions:** I. Some cars are toys.   II. All cars are machines.
...
**Statements:** All apples are fruits. Some fruits are sweet. \
**Conclusions:** I. All apples being sweet is a possibility.   II. Some apples are sweet.
...
**Conclusions:** I. Some inks are not books.   II. No ink is a book.
...
**Conclusions:** I. Some dancers are not writers.   II. Some singers are writers.
...
**Conclusions:** I. Some partners are insured.   II. Some drivers are insured.
...
**Example 21** `Shopee · pattern`

**Statements:** Some riders are students. All students are young. \
**Conclusions:** I. All riders being young is a possibility.   II. Some riders are young.
...
**Conclusions:** I. Some staff are not merchants.   II. Some managers are not merchants.
  III. All merchants being staff is a possibility.
...
**Conclusions:** I. No app is free.   II. Some useful things are not tools.
...
**Example 24** `Sea · pattern`

**Statements:** Some sellers are vendors. All vendors are verified. No verified account is banned. \
**Conclusions:** I. Some sellers are not banned.   II. All sellers being verified is a
possibility.   III. Some verified accounts are sellers.
...
**Conclusions:** I. Some pilots are not cadets.   II. Some cadets are officers. \
...
**➜ Answer: (b) All cadets are officers. No pilot is an officer.**

**Example 27** `LINE MAN · pattern`

**Statements:** Only a few engineers are managers. All managers are leaders. \
**Conclusions:** I. Some engineers are not managers.   II. Some engineers are
leaders.   III. All engineers being leaders is a possibility.
...
**Conclusions:** I. Some contracts are not verbal.   II. No contract is verbal.
  III. Some documents are contracts.
...
**➜ Answer: "Some R are not P" — and nothing else. (It does not flip into a P-first form.)**

**Example 31** `Microsoft · pattern`

**Statements:** All X are Y. Some Y are Z. \
**Question:** Which of these are possible? \
(a) All Z are X   (b) No Z is X   (c) All Y are Z   (d) Some X are not Y
...
**➜ Answer: (a), (b) and (c) are possible; (d) is impossible.**
...
(a) Some A are B; No B is C   (b) All A are B; No B is C \
(c) All B are A; No B is C   (d) Some A are B; All B are C
...
**➜ Answer: (b) All A are B; No B is C.**

**Example 33** `Adobe · pattern`
...
I. Some singers are actors   II. Some dancers are writers  
III. Some singers are writers   IV. Some actors are dancers
...
**➜ Answer: I, II and III follow. IV does not.**

**Example 35** `D. E. Shaw · pattern`

**Statements:** Some A are B. All B are C. Some C are D. No D is A. \
**Conclusions:** I. Some C are not D   II. Some B are not D  
III. Some C are A   IV. No B is D
...
#### Practice — Tier 1 — Service *(target: 25 min for 18 questions)*
...
one negative $\\Rightarrow$ negative conclusion; two "some" give nothing;
one "some" $\\Rightarrow$ "some" conclusion.
