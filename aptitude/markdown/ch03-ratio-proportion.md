...
*Parts, not sizes. Then money split by parts.*
...
$ "share of first" = N \times a/(a+b+c) , \quad "one part" = N/(a+b+c) $
...
- Different times: $"profit ratio" = "capital" \times "time"$ (call it **capital-months**).
...
HCF of 84 and 126 is 42. $84 \div 42 = 2$. $126 \div 42 = 3$.
...
Make $b$ the same. LCM of 4 and 6 is 12. \
...
Divide Rs.~960 in the ratio $5 : 7$.

**Solution**

Total parts $= 5 + 7 = 12$. One part $= 960 \div 12 = 80$. \
First $= 5 \times 80 = 400$. Second $= 7 \times 80 = 560$. Check: $400 + 560 = 960$.

**➜ Answer: Rs.~400 and Rs.~560**

**Example 4**

Find the ratio compounded of $3:4$ and $8:9$.

**Solution**

Multiply across: $(3 \times 8) : (4 \times 9) = 24 : 36$. Divide both by 12: $2:3$.

**➜ Answer: $2 : 3$**

**Example 5**

Write (i) the duplicate ratio of $5:6$, (ii) the sub-duplicate ratio of $49:81$.

**Solution**

(i) Square both: $5^2 : 6^2 = 25 : 36$. \
(ii) Square-root both: $sqrt(49) : sqrt(81) = 7 : 9$.

**➜ Answer: (i) $25:36$   (ii) $7:9$**

**Example 6**

Find the fourth proportional to 4, 6 and 14.

**Solution**

$4 : 6 = 14 : x arrow.r 4 x = 6 \times 14 = 84 arrow.r x = 84/4 = 21$.

**➜ Answer: 21**

**Example 7**

Find (i) the mean proportional between 8 and 32, (ii) the third proportional to 9 and 12.

**Solution**

(i) $x = sqrt(8 \times 32) = sqrt(256) = 16$. \
...
$x$ varies inversely as $y$. $x = 12$ when $y = 5$. Find $x$ when $y = 15$.

**Solution**

Inverse means $x y = k$. So $k = 12 \times 5 = 60$. \
When $y = 15$: $x = 60/15 = 4$.
...
Two numbers are in the ratio $5 : 8$. If 9 is added to each, the ratio becomes $8 : 11$. Find the numbers.
...
$99 - 72 = 64x - 55x$ \
$27 = 9x arrow.r x = 3$. \
Numbers: $5 \times 3 = 15$ and $8 \times 3 = 24$. \
...
**Always use one letter, never two.** A ratio $5:8$ is $5x$ and $8x$ — that is one unknown. Students who write $a$ and $b$ and then $a/b = 5/8$ need two equations and lose 30 seconds.

**Example 10** `Infosys pattern`

Rs.~3,150 is divided among A, B and C so that $A : B = 2 : 3$ and $B : C = 4 : 5$. Find C's share.

**Solution**

Make B the same in both. LCM of 3 and 4 is 12. \
...
The salaries of Arun and Bala are in the ratio $4 : 5$. Each gets an increment of Rs.~3,000 and the new ratio is $5 : 6$. Find Bala's new salary.
...
$18000 - 15000 = 25x - 24x$ \
$3000 = x$. \
Bala's old salary $= 5 \times 3000 = 15000$. \
...
Rs.~8,400 is divided among P, Q and R so that P gets twice what Q gets, and Q gets three times what R gets. Find Q's share.

**Solution**

Start from the smallest. Let R $= x$. \
Q gets three times R $arrow.r$ Q $= 3x$. \
P gets twice Q $arrow.r$ P $= 2 \times 3x = 6x$. \
...
**"P gets twice what Q gets" means $P = 2Q$, so $P : Q = 2 : 1$.** Many students write $1:2$. Read it as an equation first, then turn it into a ratio.

**Example 13** `Cognizant pattern`

A 21-litre mixture has milk and water in the ratio $5 : 2$. How much water must be added to make the ratio $5 : 3$?

**Solution**

Parts $= 5 + 2 = 7$. One part $= 21 \div 7 = 3$ L. \
Milk $= 5 \times 3 = 15$ L. Water $= 2 \times 3 = 6$ L. \
Adding water does not change the milk. Milk stays 15 L. \
In the new ratio $5 : 3$, milk is 5 parts $= 15$ L, so one part $= 3$ L. \
New water $= 3 \times 3 = 9$ L. \
Water to add $= 9 - 6 = 3$ L.

**➜ Answer: 3 litres**

**Example 14** `Infosys pattern`

A box has one-rupee, 50-paise and 25-paise coins. The **numbers** of the coins are in the ratio $5 : 6 : 8$. The total value is Rs.~30. How many 50-paise coins are there?

**Solution**

Let the counts be $5x$, $6x$, $8x$. \
Value of one-rupee coins $= 5x \times 1 = 5x$ rupees. \
Value of 50-paise coins $= 6x \times 0.50 = 3x$ rupees. \
Value of 25-paise coins $= 8x \times 0.25 = 2x$ rupees. \
Total value $= 5x + 3x + 2x = 10x = 30 arrow.r x = 3$. \
Number of 50-paise coins $= 6 \times 3 = 18$. \
...
**Ratio of coin numbers is not the ratio of coin values.** Convert every count to money before you add. If the question had said "values are in the ratio $5:6:8$", the working would be completely different.

**Example 15** `TCS NQT pattern`

Find the ratio compounded of $2:3$, the duplicate ratio of $4:5$, the sub-duplicate ratio of $36:49$ and the triplicate ratio of $1:2$.

**Solution**

Write each ratio first. \
...
Numerator: $2 \times 16 \times 6 \times 1 = 192$. \
Denominator: $3 \times 25 \times 7 \times 8 = 4200$. \
$192 : 4200$. Divide both by 8: $24 : 525$. Divide both by 3: $8 : 175$.

**➜ Answer: $8 : 175$**

**Example 16** `Wipro pattern`

$x$ varies directly as $y^2$ and inversely as $z$. When $y = 4$ and $z = 6$, $x = 12$. Find $x$ when $y = 6$ and $z = 9$.

**Solution**

$ x = (k y^2)/z $ \
Put in the known values: $12 = (k \times 16)/6$. \
$12 \times 6 = 16 k arrow.r 72 = 16 k arrow.r k = 72/16 = 4.5$. \
Now $y = 6$, $z = 9$: \
$x = (4.5 \times 36)/9 = 4.5 \times 4 = 18$.

**➜ Answer: $x = 18$**

**Example 17** `Accenture pattern`

A, B and C invest Rs.~45,000, Rs.~60,000 and Rs.~75,000 in a business for one full year. The year's profit is Rs.~36,000. Find B's share.

**Solution**

Everyone invested for the same time, so profit splits in the capital ratio. \
...
**Example 18** `TCS NQT pattern`

A starts a business with Rs.~30,000. After 4 months B joins with Rs.~45,000. After 6 months from the start, C joins with Rs.~60,000. At the end of one year the profit is Rs.~49,500. Find each partner's share.

**Solution**

Times invested, counting to the 12-month mark: \
...
**➜ Answer: Rs.~16,500 each**

---
💡 **SHORTCUT**

**Divide all capitals by a common factor before multiplying by time.** Rs.~30,000 becomes 30. You are only after a ratio, so any common scaling is free. This kills most of the arithmetic.

**Example 19** `Capgemini pattern`

A and B start a business with Rs.~24,000 and Rs.~36,000 for one year. A is the working partner and takes 15% of the profit for managing the business; the rest is divided in the capital ratio. If the profit is Rs.~24,000, what does A receive in total?

**Solution**

Step 1 — A's management share. \
$15%$ of $24000 = 0.15 \times 24000 = 3600$. \
Step 2 — what is left. \
$24000 - 3600 = 20400$. \
Step 3 — capital ratio. \
$24000 : 36000 = 2 : 3$. Total parts $= 5$. One part $= 20400 \div 5 = 4080$. \
A's capital share $= 2 \times 4080 = 8160$. \
Step 4 — A's total. \
$3600 + 8160 = 11760$. \
Check: B gets $3 \times 4080 = 12240$; $11760 + 12240 = 24000$. Correct.

**➜ Answer: Rs.~11,760**

**Example 20** `Cognizant pattern`

If $(5x + 3y)/(5x - 3y) = 7/3$, find $x : y$.

**Solution**

Use componendo–dividendo. Add the two sides' parts and subtract them.
$ ((5x+3y)+(5x-3y))/((5x+3y)-(5x-3y)) = (7+3)/(7-3) $
Numerator on the left: $5x + 3y + 5x - 3y = 10x$. \
Denominator on the left: $5x + 3y - 5x + 3y = 6y$. \
So $(10x)/(6y) = 10/4$. \
$(10 x)/(6 y) = 10/4 arrow.r x/y = 10/4 \times 6/10 = 6/4 = 3/2$. \
...
+ Two numbers are in the ratio $7 : 9$. If 12 is subtracted from each, the ratio becomes $5 : 7$. Find the larger number. 
**(a)** [54]  **(b)** [42]  **(c)** [63]  **(d)** [96]
...
+ A bag has Rs.~5, Rs.~2 and Re~1 coins whose numbers are in the ratio $3 : 4 : 5$. The total value is Rs.~336. How many Rs.~2 coins are there? 
**(a)** [48]  **(b)** [36]  **(c)** [60]  **(d)** [42]
...
+ Rs.~2,700 is shared by A, B and C. A gets half of what B and C together get. B gets one-third of what A and C together get. Find C's share. 
**(a)** [Rs.~1  **(b)** 125]  **(c)** [Rs.~900]  **(d)** [Rs.~675]  **(e)** [Rs.~1  **(f)** 350]
...
**2.** Rs.~950 — 12 parts, one part $= 190$, B $= 5 \times 190$. \
...
**6.** 5. $sqrt(12.5 \times 2) = sqrt(25)$. \
**7.** $2 : 3$ — sub-duplicate of $16:25$ is $4:5$; $(5 \times 4) : (6 \times 5) = 20 : 30$. \
**8.** Rs.~7,700 — difference is $7 - 4 = 3$ parts $= 2100$, so one part $= 700$ and total $= 11 \times 700$. \
**9.** $y = 36$. $x sqrt(y) = k = 6 \times 4 = 24$; $sqrt(y) = 24/4 = 6$. \
**10.** Rs.~14,000 — A $= 16 \times 8 + 24 \times 4 = 128 + 96 = 224$; B $= 20 \times 12 = 240$; ratio $224:240 = 14:15$, one part $= 29000/29 = 1000$. \
**11.** Rs.~10,000 — profit ratio $= 3 \times 4 : 4 \times 3 : 5 \times 2 = 12:12:10 = 6:6:5$; one part $= 34000/17 = 2000$. \
...
On a ride-hailing app the fare of every trip is split between driver and platform in the ratio $4 : 1$. The driver also pays a booking levy of S$0.40 per trip out of his own share. On Monday a driver completed 25 trips with total fare S$625. Find his net earning.

**Solution**

Step 1 — driver's gross share. \
Total parts $= 4 + 1 = 5$. One part $= 625 \div 5 = 125$. \
Driver $= 4 \times 125 = 500$. \
Step 2 — levy. \
$25 \times 0.40 = 10$. \
Step 3 — net. \
$500 - 10 = 490$.
...
Three sellers share a warehouse bill of S$15,000 in proportion to (space used $times$ months stored). Seller A used 40 m#super[3] for 6 months, B used 30 m#super[3] for 7 months, C used 50 m#super[3] for 3 months. Find each seller's bill.

**Solution**

This is the partnership rule with space instead of money. \
A $= 40 \times 6 = 240$. \
B $= 30 \times 7 = 210$. \
C $= 50 \times 3 = 150$. \
...
**➜ Answer: A S$6,000, B S$5,250, C S$3,750**

**Example 23** `Agoda · pattern`

A Bangkok hotel has deluxe and standard rooms in the ratio $3 : 7$. On one night 80% of the deluxe rooms and 60% of the standard rooms were occupied, giving 330 occupied rooms in all. How many rooms does the hotel have?

**Solution**

Let deluxe $= 3k$ and standard $= 7k$. \
Occupied deluxe $= 0.80 \times 3k = 2.4k$. \
Occupied standard $= 0.60 \times 7k = 4.2k$. \
...
A fund holds Singapore dollars and Thai baht. The **values** of the two holdings are in the ratio $5 : 3$. The exchange rate is 1 SGD $=$ 25 THB. The baht holding is THB~1,875,000. Find the SGD holding.

**Solution**

Step 1 — put both sides in the same currency. Convert the baht to SGD. \
$1875000 \div 25 = 75000$ SGD. \
Step 2 — use the ratio. \
SGD holding : baht holding (in SGD) $= 5 : 3$. \
3 parts $= 75000 arrow.r$ one part $= 25000$. \
SGD holding $= 5 \times 25000 = 125000$.
...
**Never form a ratio across two currencies without converting first.** $5 : 3$ compared "SGD value" with "SGD value". Writing $x : 1875000 = 5:3$ gives a nonsense answer of 3.1 million.

**Example 25** `Sea / Shopee · pattern`

Priya starts a shop with THB~240,000. After 5 months she withdraws THB~40,000. Wei joins 3 months after the start with THB~300,000 and 4 months later adds THB~60,000. At the end of 12 months the profit is THB~280,000. Split it.

**Solution**

Work in thousands of baht. \
...
Priya $= 13 \times 10000 = 130000$. Wei $= 15 \times 10000 = 150000$. \
Check: $130000 + 150000 = 280000$. Correct.

**➜ Answer: Priya THB~130,000, Wei THB~150,000**

---
💡 **SHORTCUT**

**Capital-months as a bar chart.** Draw a 12-month line for each partner and mark where the capital changes. Each flat piece is one rectangle: height $\times$ width. Add the rectangles. You will never lose a segment again.

**Example 26** `GIC · pattern`

The time to process a data batch varies directly as the number of records and inversely as the number of servers. 12 servers process 4.8 million records in 5 hours. How long will 18 servers take for 10.8 million records?

**Solution**

$ t = (k R)/S $ \
where $R$ is records in millions and $S$ is servers. \
Put in the known values: $5 = (k \times 4.8)/12$. \
$5 \times 12 = 4.8 k arrow.r 60 = 4.8 k arrow.r k = 60/4.8 = 12.5$. \
Now $R = 10.8$, $S = 18$: \
$t = (12.5 \times 10.8)/18$. \
$12.5 \times 10.8 = 135$. \
$t = 135/18 = 7.5$ hours.
...
Branch A has a book of THB~96 million with loans : deposits $= 3 : 5$. Branch B has a book of THB~144 million with loans : deposits $= 5 : 7$. Find the combined loans : deposits ratio for the two branches together.

**Solution**

**Branch A.** Parts $= 3 + 5 = 8$. One part $= 96 \div 8 = 12$. \
Loans $= 3 \times 12 = 36$. Deposits $= 5 \times 12 = 60$. \
**Branch B.** Parts $= 5 + 7 = 12$. One part $= 144 \div 12 = 12$. \
Loans $= 5 \times 12 = 60$. Deposits $= 7 \times 12 = 84$. \
...
**You cannot add ratios term by term.** $3:5$ and $5:7$ do not combine into $8:12$. Convert each ratio to real amounts, add the amounts, then re-form the ratio.

**Example 28** `LINE MAN · pattern`

A delivery fleet has bikes and cars in the ratio $9 : 4$. After 15 bikes are retired and 10 cars are added, the ratio becomes $3 : 2$. How many bikes were there at the start?

**Solution**

Let bikes $= 9k$ and cars $= 4k$.
$ (9k - 15)/(4k + 10) = 3/2 $
$2(9k - 15) = 3(4k + 10)$ \
$18k - 30 = 12k + 30$ \
$18k - 12k = 30 + 30$ \
$6k = 60 arrow.r k = 10$. \
Bikes at the start $= 9 \times 10 = 90$. \
...
The cost of a gaming headset splits into materials, labour and marketing in the ratio $7 : 4 : 9$. Next year materials cost rises 20%, labour rises 25% and marketing falls 10%. Find the new cost ratio and the percent change in total cost.

**Solution**

Take the three costs as 7, 4 and 9 units. Total $= 20$ units. \
Materials: $7 \times 1.20 = 8.4$. \
Labour: $4 \times 1.25 = 5.0$. \
Marketing: $9 \times 0.90 = 8.1$. \
New ratio $= 8.4 : 5.0 : 8.1$. Multiply all by 10: $84 : 50 : 81$. \
New total $= 8.4 + 5.0 + 8.1 = 21.5$. \
Change $= 21.5 - 20 = 1.5$ units. \
Percent change $= 1.5/20 \times 100 = 7.5%$ increase.

**➜ Answer: $84 : 50 : 81$; total cost up 7.5%**

**Example 30** `Grab · pattern`

In zone X the ratio of orders to riders is $12 : 1$. In zone Y it is $9 : 1$. The two zones are merged and the combined ratio of orders to riders is $10 : 1$. Find the ratio of the number of riders in X to the number in Y.

**Solution**

Let X have $x$ riders and Y have $y$ riders. \
...
Example 30 is the **alligation** idea in disguise: the combined ratio 10 sits between 9 and 12, and it lands closer to 9, so zone Y must carry more weight. Chapter 4 makes this a one-line rule.
...
+ A bonus pool of S$2,40,000 is split in proportion to (headcount $\times$ months active). Team A: 10 people for 9 months. Team B: 12 people for 5 months. Team C: 15 people for 10 months. Find each team's bonus.
...
**2.** $2 : 1$ — new tea $= 5 \times 1.2 = 6$, new coffee $= 4 \times 0.75 = 3$, so $6:3$. \
...
**9.** THB~12,000. $C = k d / L arrow.r 9000 = k \times 300/0.8 = 375k arrow.r k = 24$; $C = 24 \times 450/0.9 = 24 \times 500$. \
**10.** $3 : 2$. $40a + 30b = 36(a + b) arrow.r 4a = 6b$. \
**11.** $x : y = 4 : 1$ — componendo–dividendo gives $(4x)/(6y) = 16/6$, so $x/y = 16/6 \times 6/4 = 4$. \
...
Four positive numbers satisfy $a/b = b/c = c/d$. If $a = 27$ and $d = 8$, find $b + c$.

**Solution**

**Insight: in a continued proportion the ratio of the two ends is the common ratio cubed.**
...
$c = k d = 3/2 \times 8 = 12$. \
$b = k c = 3/2 \times 12 = 18$. \
Check $a = k b = 3/2 \times 18 = 27$. Correct. \
$b + c = 18 + 12 = 30$.
...
A rectangle has length : breadth $= 5 : 3$. The same positive number is added to both the length and the breadth, and the new ratio is $7 : 5$. By what percent does the area increase?

**Solution**

**Insight: adding the same amount to both terms of a ratio always pushes the ratio toward $1 : 1$. So $7:5$ is possible ($7/5 < 5/3$), and the amount added is forced.**
...
Old area $= 5k \times 3k = 15k^2$. \
New area $= 7k \times 5k = 35k^2$. \
Increase $= 35k^2 - 15k^2 = 20k^2$. \
Percent increase $= (20k^2)/(15k^2) \times 100 = 4/3 \times 100 = 133 1/3 %$.

**➜ Answer: $133 1/3 %$ (that is, $\approx 133.33%$)**

**Example 33** `D. E. Shaw · pattern`

A team's wins to losses stand at $5 : 8$. The team then wins $k$ more games in a row and loses none, after which the ratio is $5 : 6$. Find the smallest possible number of games the team had played before this winning run.

**Solution**

**Insight: the ratio fixes $k$ only up to a fraction. The real constraint is that wins, losses and $k$ must all be whole numbers.**
...
**➜ Answer: 39 games (with $k = 5$)**

**Example 34** `Google · pattern`

Two ad channels are compared on click-through rate.
...
**Insight: an overall rate is a weighted average of the sub-rates. The weights are the traffic sizes, and they can flip the comparison.**
...
**➜ Answer: Channel P, 65% against 35% — the sub-group winner is not the overall winner**

---
⚠️ **TRAP**

**Never average two ratios by averaging their values.** $(70 + 20)/2 = 45%$ for P is wrong; the true answer is 65%. Always go back to totals: add the numerators, add the denominators, then divide.

**Example 35** `Adobe · pattern`

Three numbers are in the ratio $3 : 4 : 5$ and their LCM is 2400. Find the numbers and their HCF.

**Solution**

**Insight: if the ratio terms are in lowest form, the numbers are $3x$, $4x$, $5x$ with HCF $= x$, and the LCM is $x$ times the LCM of the ratio terms.**

Let the numbers be $3x$, $4x$, $5x$. \
Since $3, 4, 5$ have HCF 1, the HCF of the numbers is $x$. \
LCM of 3, 4, 5: \
$3 = 3$, $4 = 2^2$, $5 = 5$, so LCM $= 2^2 \times 3 \times 5 = 60$. \
Therefore LCM of the numbers $= 60 x$.
$ 60 x = 2400 arrow.r x = 40 $
Numbers: $3 \times 40 = 120$, $4 \times 40 = 160$, $5 \times 40 = 200$. HCF $= 40$. \
Check: $120 = 2^3 \times 3 \times 5$, $160 = 2^5 \times 5$, $200 = 2^3 \times 5^2$. \
LCM $= 2^5 \times 3 \times 5^2 = 32 \times 3 \times 25 = 2400$. Correct. \
HCF $= 2^3 \times 5 = 40$. Correct.

**➜ Answer: 120, 160, 200; HCF $= 40$**

**Example 36** `Uber · pattern`

A city platform keeps a service rule: riders : drivers must stay at or below $40 : 1$. Right now there are 42,000 riders and 1,200 drivers. Next month riders will grow 5% and 8% of the current drivers will quit. How many new drivers must be hired to keep the rule?

**Solution**

**Insight: do not compare the growth rates. Compute both sides next month and compare the needed count with the surviving count.**

Step 1 — riders next month. \
$42000 \times 1.05 = 44100$. \
Step 2 — drivers still on the platform next month. \
$8%$ quit, so $92%$ remain: $1200 \times 0.92 = 1104$. \
Step 3 — drivers **needed** next month. \
The rule is $"riders"/"drivers" \\le 40$, so $"drivers" \\ge 44100/40 = 1102.5$. \
Drivers are whole people, so at least 1,103 are needed. \
Step 4 — compare. \
Surviving drivers $= 1104 \\ge 1103$. The rule already holds. \
Check: $44100 \div 1104 = 39.95$, which is below 40. Correct.

**➜ Answer: No hiring needed — 0 new drivers**

Riders grew 5% and drivers fell 8%, so the ratio did get worse. It just did not get worse **enough** to break the rule. Tier-3 questions reward finishing the arithmetic instead of guessing from the direction of change.

**Example 37** `Microsoft · pattern`

Prove that if $a/b = c/d$ then
$ (a^2 + c^2)/(b^2 + d^2) = (a c)/(b d) $
Then use it: if $(a^2 + c^2)/(b^2 + d^2) = 16/49$, $a/b = c/d$ and $a c = 48$, find $b d$.

**Solution**

**Insight: when two fractions are equal, name the common value $r$ and substitute. Every expression collapses to a power of $r$.**
...
$r^2 = 16/49$.
$ (a c)/(b d) = r^2 = 16/49 $
$ 48/(b d) = 16/49 arrow.r 16 \times b d = 48 \times 49 $
$b d = (48 \times 49)/16 = 3 \times 49 = 147$. \
...
A invests Rs.~50,000 for 12 months, B invests Rs.~75,000 for 8 months and C invests Rs.~1,00,000 for 12 months. They agree that C is **guaranteed** at least Rs.~46,000 of the profit, and any shortfall is paid by A and B in their own profit ratio. The year's profit is Rs.~80,000. Find each partner's final share.

**Solution**

**Insight: a guarantee is a second step, not a new ratio. Split normally first, then transfer.**
...
**➜ Answer: A Rs.~17,000, B Rs.~17,000, C Rs.~46,000**
...
+ A delivery platform has 900 couriers and 27,000 weekly orders. Its rule is orders : couriers $\\le 32 : 1$. Next month orders grow 12% and 5% of couriers quit. How many couriers must be hired?
...
<summary><b>Answer key</b></summary>
 ...
 \
**1.** $b + c = 90$. The ratio of the ends is the common ratio cubed: $k^3 = a/d = 81/24 = 27/8$, so $k = 3/2$. Then $c = k d = 3/2 \times 24 = 36$ and $b = k c = 3/2 \times 36 = 54$. Check $a = 3/2 \times 54 = 81$. Sum $= 54 + 36 = 90$.
...
**4.** LCM $= 420$. The numbers are $2 \times 14 = 28$, $3 \times 14 = 42$, $5 \times 14 = 70$. LCM $= "HCF" \times "LCM of " 2,3,5 = 14 \times 30 = 420$. Check: $28 = 2^2 \times 7$, $42 = 2 \times 3 \times 7$, $70 = 2 \times 5 \times 7$, so LCM $= 2^2 \times 3 \times 5 \times 7 = 420$.

**5.** Y gets Rs.~48,000. Z first takes $1/5 \times 150000 = 30000$. Remaining $= 120000$, split in $120000 : 80000 = 3 : 2$, so one part $= 24000$ and Y $= 2 \times 24000 = 48000$ (X gets 72,000). Check: $72000 + 48000 + 30000 = 150000$.

**6.** Hire 90 couriers. Orders next month $= 27000 \times 1.12 = 30240$. Couriers left $= 900 \times 0.95 = 855$. Couriers needed $= 30240 \div 32 = 945$. Hire $945 - 855 = 90$. Note the rule is on a **future** pair of numbers, so both sides must be projected before comparing.

**7.** $a c = 72$. With $a/b = c/d = r$, both $(a^2+c^2)/(b^2+d^2)$ and $(a c)/(b d)$ equal $r^2$. So $(a c)/200 = 9/25 arrow.r a c = 200 \times 9/25 = 72$.
...
**2.** Rs.~1,800 — 9 parts, one part $= 600$, middle $= 3 \times 600$. \
**3.** $20 : 24 : 27$ — make $B = 24$ (LCM of 6 and 8). \
**4.** 6. $sqrt(4.5 \times 8) = sqrt(36)$. \
**5.** $41 : 1$ — put $x = 4$, $y = 7$: $(20 + 21) : (8 - 7)$. \
**6.** Rs.~27,000 — ratio $36 : 54 = 2 : 3$, one part $= 45000/5 = 9000$. \
**7.** $A = 3$. $k = A B^2 = 27 \times 4 = 108$; $A = 108/36$. \
**8.** 18 and 26. $4(9k + 6) = 3(13k + 6) arrow.r 36k + 24 = 39k + 18 arrow.r k = 2$. \
**9.** 60 — value $= 20x + 15x + 10x = 45x = 900 arrow.r x = 20$; Rs.~5 coins $= 3x$. \
**10.** Rs.~20,000. $5x - 3y = 8000$ and $4x - 2y = 8000$; the second gives $y = 2x - 4000$; substituting, $5x - 6x + 12000 = 8000 arrow.r x = 4000$; income $= 5 \times 4000$. \
**11.** $1 : 5$. $(3:5) \times (4:9) \times (3:4) = 36 : 180$. \
...
**14.** 24. $(16 + 25 + 36)x^2 = 77x^2 = 1232 arrow.r x^2 = 16 arrow.r x = 4$; largest $= 6 \times 4$. \
**15.** $9 : 14$ — componendo–dividendo: $(14a)/(-6b) = 6/(-4) arrow.r a/b = 6/4 \times 6/14 = 9/14$. \
...
Different times $arrow.r$ profit ratio $=$ capital $\times$ time (capital-months). \
...
+ In partnership, if the times differ you must use capital $\times$ time. Capital alone is wrong.
